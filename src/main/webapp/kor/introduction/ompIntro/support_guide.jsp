	...
	<script type="text/javascript">
 	...
 	<body>
 		<div class="intro contract">
			...
			<p class="mt10"><img src="/images/img_diagram02.png" alt="클라우드서비스 등록ㆍ제공 절차"/></p>
			<h3>제공절차 설명</h3>
			<table border="0" cellspacing="0" cellpadding="0" class="basic_table" style="width:100%; border-left:none;" summary="제공절차 설명">
			<caption>제공절차 설명</caption>
				<colgroup>
					<col width="30px" />
					<col width="140px" />
					<col width="*" />
				...
				<tr>
					<th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;">
						<img src="/images/icon_num01.png" width="27" height="27" alt="01"/>
					</th>
				...
				<tr>
					...
					<td style="border-right:none; padding:15px 0 15px 15px;">
						<dl class="deco_bl">
							<dt><img src="/images/table_bullet.jpg" width="3" height="3" alt="bullet"/>&nbsp;</dt>
				...
				<tr>
					<th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
						<img src="/images/icon_num06.png" width="27" height="27" alt="06" /></th>
				...
				<tr>
					<th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
					<img src="/images/icon_num07.png" width="27" height="27" alt="07" /></th>
				...
				<tr>
					<th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
					<img src="/images/icon_num08.png" width="27" height="27" alt="08" /></th>
				...
				<tr>
					<th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
					<img src="/images/icon_num09.png" width="27" height="27" alt="09" /></th>
					<th class="txt_blue15" style="background-color:#f9f9f9; ">비즈매칭</th>
					<td class="fs15" style="border-right:none; padding:25px 0 25px 15px;">수요기관에서 요구한 서비스를 보유한 경우, 서비스를 제안할 수 있습니다.
						<span class="btn_detail"><span onclick="jsBizPop(this); return false;" style="cursor: pointer;">자세히보기</span></span>
					</td>
				</tr>
			...
			<dl class="down_btn">
				...
				<dd  class="btn_download"><a href="/resources/download/Agreement2.hwp"><img src="/images/btn_download.jpg" width="63" height="16" alt="기본협약서 양식 다운로드"/></a></dd>
			</dl>
			<dl class="down_btn">
				<dt><img src="/images/icon_docu08.png" alt="씨앗 제공자 매뉴얼" /></dt>
				<dd>씨앗 제공자 매뉴얼</dd>
				<dd  class="btn_download"><a href="/component/file/ND_directDownload.do?fp=/resources/download/0614_SupportGudie_v.0.1.pdf&fn=클라우드스토어 씨앗 제공자 매뉴얼.pdf"><img src="/images/btn_download.jpg" width="63" height="16" alt="씨앗 제공자 매뉴얼 다운로드" /></a></dd>
			</dl>    
			<dl class="down_btn" style="margin-right:0;">
				<dt><img src="/images/icon_docu08.png" alt="서비스규격 양식" /></dt>
				<dd>서비스규격 양식</dd>
				<dd  class="btn_download"><a href="/component/file/ND_directDownload.do?fp=/resources/download/SpecSample.xlsx&fn=서비스규격 양식.xlsx"><img src="/images/btn_download.jpg" width="63" height="16" alt="서비스규격 양식 다운로드"/></a></dd>
			</dl>
			<dl class="down_btn" style="margin-top:7px;">
				<dt><img src="/images/icon_docu08.png" alt="서비스가격표 양식" /></dt>
				<dd>서비스가격표 양식</dd>
				<dd  class="btn_download"><a href="/component/file/ND_directDownload.do?fp=/resources/download/0606_StandardPrice.hwp&fn=%ED%81%B4%EB%9D%BC%EC%9A%B0%EB%93%9C%EC%84%9C%EB%B9%84%EC%8A%A4%20%EA%B0%80%EA%B2%A9%ED%91%9C%20%EC%96%91%EC%8B%9D.hwp"><img src="/images/btn_download.jpg" width="63" height="16" alt="서비스가격표 양식" /></a></dd>
			</dl> 
			<dl class="down_btn"  id="doc" style="margin-right:0; margin-top:7px;">
				<dt><img src="/images/icon_docu08.png" alt="표준계약서 양식" /></dt>
				<dd>표준계약서 양식</dd>
				<dd  class="btn_download"><a href="/component/file/ND_directDownload.do?fp=/upload/contents/standard_contract.zip&fn=표준계약서.zip"><img src="/images/btn_download.jpg" width="63" height="16" alt="표준계약서 양식 다운로드"/></a></dd>
			</dl> 
		</div>
<script> 	
