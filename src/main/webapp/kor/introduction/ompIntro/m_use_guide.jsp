...
<html lang="ko">
 	...
 	<body>
 			...
 			<div class="intro contract">
				...
				<p><img src="/images/img_diagram01.png" /></p>
              ...
              <h3>이용절차 설명</h3>
                <table border="0" cellspacing="0" cellpadding="0" class="basic_table" style="width:100%; border-left:none;">
                  ...
                  <tr>
                    ...
                    <td class="fs15" style="border-right:none; padding:15px 0 10px 15px;">
                    	...
                    	<ol>
                    		...
                    		<li>
                    			(2) 수요공고 : 수요기관의 납품조건을 상세화하여 공고할 수 있도록, 수요 공고기능을 제공
                    			<p class="fs11 txt_red ml20">(* 전자조달시스템 공지 대상인 경우 씨앗에 병행 공고 가능하지만, 전자조달시스템을 대체하지는 못함)</p>
                    		</li>
                  ...
                  <tr>
                    <th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
                    	<img src="/images/icon_num05.png" width="27" height="27"/>
                    </th>
                  ...
                  <tr>
                    <th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
                    	<img src="/images/icon_num06.png" width="27" height="27"/>
                    </th>
                  ...
                  <tr>
                    <th class="txt_blue15" style="background-color:#f9f9f9; border-right:none;  ">
                    	<img src="/images/icon_num08.png" width="27" height="27"/>
                    </th>
                ...
                <dl class="down_btn">
                    ...
                    <dd>씨앗 이용자 매뉴얼</dd>
                    <dd class="btn_download"><a href="/component/file/ND_directDownload.do?fp=/upload/contents/20180604_v.3.0.pdf&fn=씨앗 이용자 매뉴얼.pdf"><img src="/images/btn_download.jpg" width="63" height="16"/></a></dd>
                </dl>
<!--                 
                <dl class="down_btn" style="margin-right:0;">
                    <dt><img src="/images/icon_docu08.png"/></dt>
                    <dd style="line-height:15px; padding-top:6px;">공공기관<br/>민간클라우드 이용<br/>가이드(행정안전부)</dd>
                    <dd class="btn_download"><a href="/component/file/ND_fileDownload.do?id=ca5442d7-fdbf-493a-9ca5-c2c7d3180604"><img src="/images/btn_download.jpg" width="63" height="16"/></a></dd>
                </dl>
 -->                
                <dl class="down_btn" style="margin-right:0;">
                	<dt><img src="/images/icon_docu08.png"/></dt>
                    <!--1017수정--><dd style="line-height:15px; padding-top:6px;">공공부문 클라우드서비스<br/>유통 및 활용 가이드라인<br/>(과학기술정보통신부)</dd>
                    <!--다운로드 버튼 수정--><dd class="btn_download"><a href="/component/file/ND_directDownload.do?fp=/resources/download/Public_sector_cloud_service_distribution_and_utilization_guidelines_2017.pdf&fn=공공부문 클라우드서비스 유통 및 활용 가이드라인.pdf"><img src="/images/btn_download.jpg" width="63" height="16"/></a></dd>
                </dl> 
<!--            
