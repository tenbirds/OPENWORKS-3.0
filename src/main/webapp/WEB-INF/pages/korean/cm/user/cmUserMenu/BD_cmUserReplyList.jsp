...
<body>
		...
		<!-- container -->
		<div id="container">
			<jsp:include page="/korean/cm/user/cmUserMenu/INC_cmUserMenuLeft.do?cmmntyMenuCode=3&amp;cmmntyId=${cmUserMenuView.cmmntyId}" flush="true"></jsp:include>
			<!-- //side navigation bar -->
			<!-- contents -->
			<div id="contents">
				<h2>작성 댓글</h2>
				...
				<table class="tbl_list">
					...
					<c:forEach items="${pager.list}" var="data" varStatus="status">
						<tr>
							...
							<td><c:out value='${data.wrterNcnm}'/></td>
