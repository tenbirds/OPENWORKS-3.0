...
<script type="text/javascript">
    ...
    <form id="menuModiForm" method="post">
    	<input type="hidden" name="cmmntyId" id="cmmntyId"  value="<c:out value="${dataVo.cmmntyId}" />" />
    	<input type="hidden" name="cmmntyMenuCode" id="cmmntyMenuCode"  value="<c:out value="${dataVo.cmmntyMenuCode}" />" />
		<table>
			<colgroup>
				<col style="width:25%">
				<col style="*">
			...
			<tbody>
				<tr>
					...
					<td>
					<c:if test="${dataVo.cmmntyBbsTyCd == 0}">
					일정관리
					</c:if>
					<c:if test="${dataVo.cmmntyBbsTyCd != 0}">
					<c:out value="${dataVo.cmmntyBbsTyNm}" />
					</c:if>
					</td>
				</tr>
				<tr>
					<td class="tit"><span class="point">게시판 이름</span></td>
					<td><input type="text" id="cmmntyMenuNm" name="cmmntyMenuNm" title="게시판 이름 입력" value="<c:out value='${dataVo.cmmntyMenuNm}'/>" style="width:330px;"></td>
				</tr>
				<tr>
					<td class="tit">게시판 설명</td>
					<td>
						<textarea id="cmmntyMenuDc" name="cmmntyMenuDc" style="width:330px; height:170px;" onkeyup="javascript:displayBytes(1000,'cmmntyMenuDc');"  onblur="javascript:displayBytes(1000,'cmmntyMenuDc');" ><c:out value='${dataVo.cmmntyMenuDc}'/></textarea>
				...
				<div class="btn_area">
					<div class="btn_navi"><a href="#none" onclick="jsUpdateAction('#menuModiForm');"><span class="save">저장</span></a></div>
