...
<%@ taglib uri="http://www.openworks.kr/jsp/jstl" prefix="op"%>
		...
		<!-- 2016.11.18 [비즈매칭] - [비즈매칭]으로 변경 -->
			<!-- contents -->
			<div class="contents biz">
				<h2 class="tit">찾고 계신 서비스가없으신가요?</h2>
				<p class="ac mb70">비즈매칭 서비스를 통해 찾고 계신 솔루션이나 서비스를 지원해 드립니다.</p>
				<!-- 검색 폼 -->
				...
				<div class="title-area">
					...
					<div class="search-area">
						<span class="search-box">
	                        ...
	                        <a href="#" id="sech" name="sech" title="검색" onclick="jsSearch();" class="">검색</a>
						</span>
					</div>
					<!-- //sorting -->
				</div>
				...
				<div class="btn-area ar">
					<a href="#" onclick="jsSearchReset(); return false;" class="b-btn type3"><strong><span class="ml10 mr10">전체보기</span></strong></a>
			                                ...
			                                <c:choose>
			                                    <c:when test="${arrange.columnId eq 'BBSCTT_SJ'}">
			                                        ...
			                                        <td>
			                                            ...
			                                            <c:if test="${baseVo.bizProgression eq 'INC'}"><span class="condi_b">미완료</span></c:if>
