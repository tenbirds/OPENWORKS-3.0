...
<div id="container">
    ...
    <div id="contents">
        ...
        <section class="content">
            ...
            <p class="txt_desc">Si no puede encontrar el producto (o servicio) que busca o no puede decidir qué solución o servicio elegir, este servicio lo acerca a potenciales vendedores cuando ingresa los productos que busca.</p>
            <form name="dataForm" id="dataForm" method="post" enctype="multipart/form-data" action="${action}" onsubmit="return false;">
                    ...
                    <tbody>
                        ...
                        <tr style="height: 62px;">
                            ...
                            <td class="last" id ="ctgryCodes" style="padding-top: 0px;">
                                <span class="btn_light_gray02"><a href="#" class="big" onclick="jsCtgrySelPop(this);">Seleccionar</a></span>
                        ...
                        <!-- 제목 -->
                        <tr>
                            <td class="tit"><label for="bbscttSj">Titulo</label></td>
                            <td class="last">
                                <input type="text" name="bbscttSj" id="bbscttSj" class="input" style="width:565px;" title="Ingrese Título" value="<c:out value='${dataVo.bbscttSj}'/>"/>
                            </td>
                        </tr>
                        <!-- 확장 컬럼 입력 -->
                        <c:forEach var="extensionVo" items="${boardConfVo.formColunms}">
                            <c:if test="${!empty extensionVo.columnTy}">
                                <tr>
                                    <td class="tit">Fecha de cierre</td>
                                    <td>
                                        <c:choose>
                                                ...
                                                <c:choose>
                                                    <c:when test="${extensionVo.columnId  eq 'ESTN_COLUMN6' }">
                                                        <div class="calendar_input">
                                                            <input type="text" id="endDt" name="endDt" value="${param.endDt}" title="" class="input" style="width:207px;" readonly="readonly"/>
                                                            <!--<button title="종료일 레이어 달력 열림">종료일</button> -->
                                                        </div>
                                                        <span class="txt"></span>
                                                        ...
                                                        <span class="txt">Minutos</span>
                                                        <!--<span class="txt" style="display: block; margin-top: 5px;"> ※ Si no introduce la fecha de cierre y luego se almacena más de treinta días a partir de hoy de forma automática.</span>-->
                                                    </c:when>
                                                    <c:otherwise>
                        ...
                        <tr>
                            ...
                            <td class="last">
                                ...
                                <c:if test="${boardConfVo.userEditorYn eq 'Y'}">
                                    <textarea name="bbscttCn" id="bbscttCn" rows="15" style="width:817px; height:244px;" cols="30" onKeyUP="javascript:cal_pre();" title="Ingrese contenido">${dataVo.bbscttCn}</textarea>
                                ...
                                <c:if test="${boardConfVo.userEditorYn eq 'N'}" >
                                    <%--<textarea name="bbscttCn" id="bbscttCn" rows="15" style="width:817px; height:244px;" onKeyUP="javascript:cal_pre();" title="" placeholder="Por favor, tenga en cuenta que la sesión se desconectará al escribir el contenido durante mucho tiempo.">${dataVo.bbscttCn}</textarea>--%>
                                    <textarea name="bbscttCn" id="bbscttCn" rows="15" style="width:817px; height:244px;" onKeyUP="javascript:cal_pre();" title="Ingrese contenido" placeholder="">${dataVo.bbscttCn}</textarea>
                                </c:if>
                                ...
                                <td class="last">
                                    ...
                                    <c:choose>
                                        <c:when test="${boardConfVo.othbcYn eq 'Y'}">
                                            ...
                                            <label for="othbcAtN">&nbsp;Ocultos</label>
                                ...
                                <td class="last">
                                    <div class="file">
                                            ...
                                            <c:if test="${fn:length(dataVo.fileList) > 0}">
                                                ...
                                                <ul>
                                                    <c:forEach items="${dataVo.fileList}" var="fileVo">
                                                        <li class="mar_b5">
                                                            <a href="#" onclick="jsFileDelete(this, '<c:out value='${fileVo.fileSeq}'/>', '${fileVo.fileId}');"><img src="<c:url value='/resources/cmmnty/default/images/icon_cancel_red.png' />" alt="Eliminar" class="vm"/></a>
                                        ...
                                        <div style="width:570px; height:24px; border: 1px solid #ccc;">
                                            <input type="file" name="multiFiles" id="multiFiles" <c:if test="${boardConfVo.maxFileCnt <= dataVo.fileCnt}"> disabled="disabled"</c:if> value="Explorar"  style="width:500px;"/>
                ...
                <div class="btn_area">
                    <div class="btn_l">
                        <div class="btn_navi_g"><a href="#" onclick="jsList(); return false;"><span class="total">Lista</span></a></div>
                    </div>
                    <div class="btn_r">
                        <div class="btn_navi"><a href="#" onclick="jsSubmit();"><span class="reg">Registrarse</span></a></div>
                        <div class="btn_navi_g"><a href="#" onclick="jsCancel();"><span class="cancel">Cancelar</span></a></div>
                    </div>
                </div>
                <!-- //버튼 -->
            </form>
