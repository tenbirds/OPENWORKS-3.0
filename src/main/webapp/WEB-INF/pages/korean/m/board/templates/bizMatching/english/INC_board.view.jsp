                        ...
                        <c:choose>
                            <c:when test="${arrange.columnId eq 'BBSCTT_SJ' or arrange.columnId eq 'RDCNT'}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="last cs" colspan="7"> 
                                            ...
                                            <c:if test="${empty dataVo.ctgryList}">
                                                You can not find the chosen category.
                                            </c:if>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <c:if test="${arrange.columnId eq 'RDCNT'}">
                                        <td class="tit">Number of matches</td>
                                        <td><c:out value='${dataVo.commentCnt}'/></td>
                                        <td class="tit">View count</td>
                            ...
                            <c:when test="${arrange.columnId eq 'REGIST_ID' or arrange.columnId eq 'REGIST_DT' or arrange.columnId eq 'ESTN_COLUMN6'}">
                                ...
                                <c:if test="${arrange.columnId eq 'ESTN_COLUMN6'}">
                                    ...
                                    <c:choose>
                                        ...
                                        <td class="last">
                                            <c:if test="${dataVo.bizProgression eq 'COM'}"><span class="condi_a">Complete</span></c:if>
                                            <c:if test="${dataVo.bizProgression eq 'INC'}"><span class="condi_a">Incomplete</span></c:if>
                                            <c:if test="${dataVo.bizProgression eq 'PRO'}"><span class="condi_b">In progress</span></c:if>
                                        </td>
                                    </tr>
                                </c:if>
                            </c:when>
                                    ...
                                    <td colspan="8" class="last">
                                        <div class="add_file">
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a href="#"></a> There are no attachments.
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
                                    </td>
