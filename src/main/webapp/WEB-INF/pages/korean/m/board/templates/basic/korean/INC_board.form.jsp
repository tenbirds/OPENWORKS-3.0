					...
					<label for="bbscttCn">
						<div id="contentsErrorDiv"></div> 
							<c:if test="${boardConfVo.userEditorYn eq 'Y'}">
								<textarea name="bbscttCn" id="bbscttCn" rows="15" style="width: 690px; height: 360px;" cols="30"
									title="내용을 입력해주세요">${dataVo.bbscttCn}</textarea>
                           ...
                           //]]>
							...
							</c:if> <c:if test="${boardConfVo.userEditorYn eq 'N'}">
								<textarea name="bbscttCn" id="bbscttCn" rows="15"
									style="width: 767px; height: 360px;" title="내용을 입력해주세요">${dataVo.bbscttCn}</textarea>
							</c:if></td>
				</tr>
