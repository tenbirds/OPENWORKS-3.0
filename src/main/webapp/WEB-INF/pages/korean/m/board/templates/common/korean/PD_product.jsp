...
<!-- 컨텐츠영역 -->
    <div id="pop_wrap">
        <div class="pop_container">
                    ...
                    <dd class="float_l mar_b10 mar_l2" style="float: right;margin-bottom: 10px;">
	                    <form id="dataForm" name="dataForm" action="PD_product.do" >
				            ...
				            <select name="q_searchKeyType" id="q_searchKeyType" title="서비스명 검색" onchange="if($(this).val() != ''){$(this).next().focus().select();}" style="width:115px; margin-left:100px">
					            <option value="GOODS_NM___1009"<c:if test="${param.q_searchKeyType eq 'GOODS_NM___1009'}"> selected="selected"</c:if>>서비스명</option>
					        </select>
            ...
            총 <em class="orange"><c:out value='${pager.totalNum}'/></em>개
            <c:set var="index" value="${pager.indexNo}"/>
            <table  cellspacing="0" border="0" summary="서비스선택" class="tbl_pop">
