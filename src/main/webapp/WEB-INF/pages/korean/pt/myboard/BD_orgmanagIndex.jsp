...
<%-- 	<op:jsTag type="openworks" items="ui" /> --%>
    ...
    var jsListReq = function(page) {
        ...
        jsRequest("dataForm", "BD_orgmanagIndex.do", "get");
    };
					...
					<table>
						...
						<tbody>
	                        ...
	                        <tr>
	                            ...
	                            <!-- 상태 -->
	                            <td>
		                            <c:if test="${baseVo.bizProgression eq 'COM'}"><span class="condi_a"></span></c:if>
		                            <c:if test="${baseVo.bizProgression eq 'INC'}"><span class="condi_a"></span></c:if>
		                            <c:if test="${baseVo.bizProgression eq 'PRO'}"><span class="condi_d"></span></c:if>
	                           </td>
