...
<form id="passwordForm" name="passwordForm">
    ...
    <div style="padding:10px 10px 10px 10px;">
		...
		<div class="btnArea" style="padding-top:30px;">
			...
			<a href="ND_dmandExaminDownloadAction1.do" class="btns st4" style="width:190px;">‘18년 수요예보조사표 다운로드</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			</c:if>			
			<a href="ND_dmandExaminDownloadAction.do" class="btns st44" style="width:190px;">‘19년 수요예보조사표 다운로드</a>			
		</div>
