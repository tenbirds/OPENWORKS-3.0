...
<h3>시스템 요구조건</h3>
<table class="tbl_st4 mt10" summary="시스템 요구조건">
	...
	<thead hidden="hidden">
		<tr>
			<th colspan="2" scope="col">호스팅방식|스케일링|플랫폼|런타임|미들웨어|프레임워크|서비스|애드온|확장기능여부|위치</th>
		</tr>
	</thead>
	<tfoot hidden="hidden">
		<tr>
			...
			<td>
              ...
              <c:when test="${pass2.consumerYn eq 'N'}">
	              ...
	              <!-- 2064 -->
		                ...
		                <label for="paas_hostingMethod" hidden="hidden">호스팅방식 선택</label>
		              </span>
                </dd>
              </c:when>
            </c:choose>
            ...
            <c:choose>
              ...
              <c:when test="${pass2.consumerYn eq 'N'}">
                ...
                <c:forEach items="${scalingList}" var="scaling" varStatus="status">
                    <input type="checkbox" id="paas_scaling_${scaling.PRVCD}" name="scaling_${scaling.PRVCD}" value="${scaling.PRVCD}" />
                    <label for="paas_scaling_${scaling.PRVCD}">${scaling.PRVNM}</label>
                </c:forEach>
                  </dd>
              </c:when>
          	</c:choose>
			...
			<td>
              ...
              <c:when test="${pass2.consumerYn eq 'N'}">
              	<dd>
		                ...
		                <label for="paas_platform" hidden="hidden">플랫폼 선택</label>
		              </span>
              	</dd>
            	</c:when>
          	</c:choose>
			...
			<td>
			    ...
			    <c:forEach items="${pass2}" var="pass2" varStatus="status">
                	<c:choose>
                        ...
                        <c:when test="${pass2.consumerYn eq 'N'}">
                            <dd>
                            		<input type="checkbox" id="pass_extendFunction" name="extendFunction" value="Y"/> 
                            		<label for="pass_extendFunction">확장기능</label>
                            </dd>
                        </c:when>
                    </c:choose>
	            </c:forEach>
                        ...
                        <c:when test="${pass2.consumerYn eq 'N'}">
                            <dd>
		                        ...
		                        <span id="paas_spanGeolocations" class="sel_box">
		                            ...
		                            <label for="paas_geolocations" hidden="hidden">위치</label>
		                        </span>                            
                            </dd>
                        </c:when>
                    </c:choose>
