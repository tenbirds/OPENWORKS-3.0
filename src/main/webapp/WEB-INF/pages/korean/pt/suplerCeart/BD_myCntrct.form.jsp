    ...
    <script type="text/javascript">
	  ...
	  //삭제 버튼
        ...
        function jsServiceSearchPopup(el, idx){
            $(el).colorbox({
                title : "계약서비스 선택",
                href : "/korean/pt/popup/PD_myServicePop.do?idx="+idx,
                width : "640",
                height : "600",
                overlayClose : false,
                escKey : false,
	 ...
	 // 저장 vaildation 체크
	    ...
	    var jsCntrctSubmit = function(type){
           ...
           if($("#cntrctSn").val() == ''){
            ...
            // 실제 저장 처리
            $("#dataForm").attr("action", "ND_suplerCntrctRegistAction.do");
            $("#dataForm").submit();
	    }
		...
		<form name="dataForm" id="dataForm" method="post" enctype="multipart/form-data" >
            ...
            <table class="tbl_st4 e2">
					...
					<tr class="companyInfo" style="display:none;">
						...
						<td><input type="text" name="cmpnyNm" id="cmpnyNm" value="${baseVo.orgnNm}" /></td>
					</tr>
					<tr>
					...
					<tbody>
						...
						<c:forEach items="${baseList}" var="listData" varStatus="status">
						 <tr><input type="hidden" name="cntrctSvcSns" value="${listData.cntrctSvcSn}"> 
							<td class="lef"><a href="#"  onclick="jsServiceSearchPopup(this,'${status.index}'); return false;" class="btns st3">검색</a>
						...
						<c:if test="${empty baseList}">
							...
							<td class="lef"><a href="#"  onclick="jsServiceSearchPopup(this,''); return false;" class="btns st3">검색</a>
                        ...
                        <c:choose>
                        	<c:when test="${baseVo.cntrctSn == null}">
                       	 	...
                       	 	<c:otherwise>
	                       		...
	                       		<a href="#" onclick="javascript:returnList(); return false;" class="btns st3 icn icnBck">확인</a>
                        	</c:otherwise>
                        </c:choose>
                    </c:if>
