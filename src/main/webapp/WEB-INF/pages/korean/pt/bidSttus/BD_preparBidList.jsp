...
<head>
    ...
    <script type="text/javascript">
	    ...
	    var jsDetailView = function(notifyNum, notifySeq){
            ...
            document.dataForm.action = "/korean/pt/bidSttus/BD_preparBidView.do";
            document.dataForm.method = "GET";
            document.dataForm.submit();
	    }
    </script>
...
<body>
	<div class="bidNoti">	
	    <form name="dataForm" id="dataForm">
	        ...
	        <input type="hidden" name="bidKndCd"    id="bidKndCd"   value="1002"/>        <!--  공고종류 -->
						...
						<tr>
							...
							<td>
								<div class="cateArea">
									...
									<div class="inputWrap">
										<input type="text" name="searchKeyWord01" id="searchKeyWord01" value="${searchKeyWord01}" title="검색"/><label for="searchKeyWord01"></label>
									</div>
								</div>
							</td>
						</tr>
