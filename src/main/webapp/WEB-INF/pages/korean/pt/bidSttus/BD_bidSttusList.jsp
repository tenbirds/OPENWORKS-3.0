...
<head>
    ...
    <script type="text/javascript">
	    ...
	    var jsDetailView = function(notifyNum, notifySeq){
            ...
            document.dataForm.action = "/korean/pt/bidSttus/BD_bidSttusDetailView.do";
	...
	<div class="bidNoti">		
      ...
      <input type="hidden" name="p_notifySeq" id="p_notifySeq"   />                 <!--  상세페이지용 -->
	    ...
	    <input type="hidden" name="bidKndCd"    id="bidKndCd"   value="1001"/>        <!--  공고종류 -->
			...
			<div class="schOpt on">
				<table class="tbl_st4" summary="진행 중 공고 검색">
				<caption>진행 중 공고 검색</caption>
				<colgroup>
					<col width="20%"/>
					<col width="*"/>
				</colgroup>
				<thead hidden="hidden">
					<tr>
						<th colspan="2" scope="row">공고명/공고번호</th>
					</tr>
				</thead>
				<tfoot hidden="hidden">
					<tr>
				...
				<tbody>
						<tr>
							...
							<td>
								<div class="cateArea">
									...
									<div class="inputWrap">
										<input type="text" name="searchKeyWord01" id="searchKeyWord01" value="${searchKeyWord01}" title="검색어 입력"/><label for="searchKeyWord01"></label>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td class="term">
							    <span class="sel_box">
									<select name="searchDiv02" id="searchDiv02">
								...
								<input type="text" name="searchStartDt" id="searchStartDt" value="${searchStartDt}" /><label for="searchStartDt"></label>
								 ~ 
								<input type="text" name="searchEndDt" id="searchEndDt" value="${searchEndDt}" /><label for="searchEndDt"></label>
				...
				<div class="list_st1">
					...
					<table class="tbl_st1" summary="진행 중 공고 목록">
					<caption>진행 중 공고 목록</caption>
					<colgroup>
						<col width="10%"/>
						<col width="10%"/>
						<col width="*"/>
						...
						<tfoot hidden="hidden">
							<tr>								
								<th scope="row" colspan="7">공고번호</th>
							</tr>
						</tfoot>
						<tbody>
