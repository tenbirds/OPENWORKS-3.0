	...
	<tbody>
        <c:forEach items="${iassDs}" var="iassDs" varStatus="status">
            <c:choose>
                ...
                <c:when test="${iassDs.consumerYn ne 'Y'}">
					<tr>
	...
	<tbody>
        <c:forEach items="${iassDd}" var="iassDd" varStatus="status">
            <c:choose>
                ...
                <c:when test="${iassDd.consumerYn ne 'Y'}">
					<tr>
...
<table class="tbl_st1 mt0">
	...
	<tbody>
		...
		<tr>
			...
			<td><input type="text" name="dbStorgSpace" /></td>
	...
	<tbody>
        <c:forEach items="${iassI}" var="iassI" varStatus="status">
            <c:choose>
                ...
                <c:when test="${iassI.consumerYn ne 'Y'}">
					<tr>
					    <td><input type="text" name="cdnTransVlmn" value="${iassI.cdnTransVlmn}"/></td>
					    <td><input type="text" name="cdnRequCnt"   value="${iassI.cdnRequCnt}"/></td>
					    <td><input type="text" name="webGoodsKind" value="${iassI.webGoodsKind}"/></td>
					    <td><input type="text" name="webAccess"    value="${iassI.webAccess}"/></td>
					    <td><input type="text" name="mntingVm"     value="${iassI.mntingVm}"/></td>
					    <td><input type="text" name="mntingIdCnt"  value="${iassI.mntingIdCnt}"/></td>
					</tr>
                </c:when>
            </c:choose>
        </c:forEach>
	...
	<tbody>
        <c:forEach items="${iassI}" var="iassI" varStatus="status">
            <c:choose>
                ...
                <c:when test="${iassI.consumerYn ne 'Y'}">
					<tr>
					    <td><input type="text" name="bakupCnt"    value="${iassI.bakupCnt}"/></td>
					    <td><input type="text" name="bakupStorg"  value="${iassI.bakupStorg}"/></td>
					    <td><input type="text" name="mangFunc"    value="${iassI.mangFunc}"/></td>
					    <td><input type="text" name="sectyVpn"    value="${iassI.sectyVpn}"/></td>
					    <td><input type="text" name="sectySslvpn" value="${iassI.sectySslvpn}"/></td>
					    <td><input type="text" name="techSupt"    value="${iassI.techSupt}"/></td>
					</tr>
                </c:when>
            </c:choose>
        </c:forEach>
