...
%>
			...
			%>
				<tr>
					<th rowspan="2" style="white-space:normal;">
						<a href="<%=URL%>" style="font-size:16px; color:#0186e1; word-break:keep-all;"><%=search_col.w3GetField("saas_cloud", "GOODSNM", idx).replaceAll("<!HS>","<em class=\"txt-word\">").replaceAll("<!HE>","</em>") %>
		...
		<%}else if( "saas_cloud".equals(collection)){ %>
		<!-- paging -->
		<div class="paging">
