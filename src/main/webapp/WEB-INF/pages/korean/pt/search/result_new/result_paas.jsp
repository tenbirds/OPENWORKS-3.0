...
%>
		<div class="section">
          	<dl class="search-result">	
              	<dt>
              		<!-- PaaS 검색결과 -->
              		<h3>PssS <i><%=resultColTotalCnt %></i>건</h3>
<%-- 					 이전 소스 : 화면에서 제외된 소스	
					...
					<input type="hidden" id="goodsTyCd" name="goodsTyCd" value="1001"/>
	              	<!-- 필터 적용 내용 출력 -->
			...
			%>
				...
				<tr>
					...
					<th rowspan="2" style="white-space:normal;">
						<a href="<%=URL%>" style="font-size:16px; color:#0186e1; word-break:keep-all;"><%=search_col.w3GetField("paas_cloud", "GOODSNM", idx).replaceAll("<!HS>","<em class=\"txt-word\">").replaceAll("<!HE>","</em>") %></a>
