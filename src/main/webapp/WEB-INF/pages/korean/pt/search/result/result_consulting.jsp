						...
						<div class="contArea">
							<div class="cont">
								...
								<div class="sech_result">검색결과<span class="num"><em>${thisTotalCount}</em></span>건</div>
										<c:if test="${collection == 'consulting'}">
										<div class="select">
...
%>
							...
							<c:choose>
								<c:when test="${collection == 'ALL' && thisTotalCount > 3 }">
									<div class="btn">
										<a href="#" class="btn_more" onClick="javascript:doCollection('${thisCollection}');"><img src="/resources/web/theme/default/images/btn/btn_more.gif" alt="컨설팅 서비스 더보기"></a>
									</div>
								</c:when>
							</c:choose>
							</div>
