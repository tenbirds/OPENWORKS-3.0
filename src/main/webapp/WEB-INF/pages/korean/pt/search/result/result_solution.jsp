...
%>
											<li>
												<div class="info">
													<div class="photo"><a href="<%=URL%>"><img src="<%=GOODSIMAGEFILESEQ%>" alt="KeyShot HD 5 Node"></a></div>
													<div class="subject"><a href="<%=URL%>">
<%
													if (CNTC_GOODS_IMAGE_SEQ.length() > 0 ) {
%>
													<img src="<%=CNTC_GOODS_IMAGE_SEQ%>" alt="titleImg">
<%
													}
%>
													<%=GOODSNM%></a></div>
...
%>
								...
								<c:choose>
									<c:when test="${collection == 'ALL' && thisTotalCount > 3 }">
										<div class="btn">
											<a href="#" class="btn_more" onClick="javascript:doCollection('${thisCollection}');"><img src="/resources/web/theme/default/images/btn/btn_more.gif" alt="솔루션 서비스 더보기"></a>
										</div>
									</c:when>
								</c:choose>
							</div>
