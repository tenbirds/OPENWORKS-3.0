...
<head>
    ...
    <script type="text/javascript">
	    ...
	    var jsListSearch = function(page){
	        ...
	        document.dataForm.action = "/korean/pt/popup/PD_wholeServicePop.do";
 ...
 <body class="winPopup serSel">
	...
	<div>
		<form name="dataForm" id="dataForm">	        
			...
			<input type="hidden" name="idx"  id="idx"  value="${idx}"/> <!--  현재 페이지 -->
            <!-- 검색영역 -->
			<div class="schArea">
				<span class="sel_box">
				...
				<div>
					<input type="text" name="searchKeyWord" id="searchKeyWord" value="${searchMap.searchKeyWord}"/>
				</div>
				<a href="#" onclick="javascript:jsListSearch(1);" class="btns st5">검 색</a>
			</div>
			<!--// 검색영역 -->
			<div class="list_st1">
				<p class="head">
