 ...
 <body class="winPopup serSel">
	...
	<div>
		<form name="dataForm" id="dataForm">	        
			...
			<input type="hidden" name="immeGubun"   id="immeGubun" value="${imme}"/>         <!--  이용자ID -->			
			...
			<div class="list_st1">
				...
				<table class="tbl_st4">
					<tr>
					    ...
					    <th>서비스코드</th>
					    <td>
					    	<input type="text" name="goodsCode" id="goodsCode" value="${goodsCode}" size="10" maxlength="12" />
					    </td>					    
					</tr>
					<tr>
					    <th>서비스명</th>
					    <td>
					    	<input type="text" name="goodsNm" id="goodsNm" value="${goodsNm}" maxlength="100" />
					    </td>					    
					    <th>제공자ID</th>
					    <td>
					    	<input type="text" name="suplerId" id="suplerId" value="${suplerId}" maxlength="20" />
					    </td>					    
					</tr>
					<tr>
					    <th>임의서비스</th>
					    <td>
					    	<input type="checkbox" name="imme" onclick="jsAuthTypeStrAdd(this);" <c:if test="${imme eq 'Y'}">checked="checked"</c:if>/>
					    ...
					    <td colspan="2" align="right">
							<a href="#"  onclick="jsListSearch2(1); return false;">					    
						    	<span class="btns st3">
						    		검색
						    	</span>
						    </a>	
