        ...
        var jsRequestSend = function(){
            ...
            if(checkEditor()){
                if(confirm("견적요청서를 발송 하시겠습니까?")) {
                    ...
                    $("#dataForm").attr("action", "ND_beforeRequestPaasAction.do");
                    $("#dataForm").submit();
                }
            }
        };
	...
	<div class="conWrap detailRequ paas">
		...
		<table class="tbl_st1">
			...
			<tbody>
				<tr>
					<th>Language</th>
					<td><input type="text" name="langSys" id="langSys" /></td>
				</tr>
				<tr>
					<th>Frameworks</th>
					<td><input type="text" name="frameworkSys" id="frameworkSys" /></td>
				</tr>
				<tr>
					<th>Cache</th>
					<td><input type="text" name="cacheSys" id="cacheSys" /></td>
				</tr>
				<tr>
					<th>DBMS</th>
					<td><input type="text" name="dbmsSys" id="dbmsSys" /></td>
				</tr>
				<tr>
					<th>Fast Deploy</th>
					<td><input type="text" name="fastDeploySys" id="fastDeploySys" /></td>
				</tr>
				<tr>
					<th>etc</th>
					<td><input type="text" name="etcSys" id="etcSys" /></td>
				</tr>
			</tbody>
		</table>
	</div>
