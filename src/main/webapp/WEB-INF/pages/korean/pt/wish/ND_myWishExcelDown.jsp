...
<c:set var="excelNm" value="${wishListInfo.auditlogNm}"/>
<%
//******************************MS excel******************************
		...
		<div id="이용희망목록_다운로드_양식_2800" align="center" x:publishsource="Excel">
			<table border="0" cellpadding="0" cellspacing="0" width="977" style='border-collapse:collapse;table-layout:fixed;width:734pt'>
			 ...
			 <tr height='31' style='mso-height-source:userset;height:23.25pt'>
			  ...
			  <td colspan='5' class='xl862800' style='border-right:1.0pt solid black;border-left:none'><c:out value="${wishListInfo.auditlogNm}"/></td>
			 </tr>
			 ...
			 <tr height='22' style='height:16.5pt'>
			  ...
			  <td class='xl632800'><c:out value="${wishListInfo.userId}"/></td>
			  <td class='xl652800'>적용일시</td>
			  <td colspan='2' class='xl842800' style='border-right:1.0pt solid black;border-left:none'><c:out value="${wishListInfo.srcDt}"/></td>
			 </tr>
			 <tr height='22' style='height:16.5pt'>
			  <td height='22' class='xl152800' style='height:16.5pt'></td>
			  ...
			  <td class='xl642800' style='border-top:none;border-left:none'><c:out value="${wishListInfo.keyWord}"/></td>
			  <td class='xl652800' style='border-top:none;border-left:none'>카테고리</td>
			  <td colspan='2' class='xl932800' style='border-right:1.0pt solid black;border-left:none'><c:out value="${wishListInfo.ctgryCode}"/></td>
			 </tr>
			 <tr height='22' style='height:16.5pt'>
			  <td height='22' class='xl152800' style='height:16.5pt'></td>
			  <td class='xl652800' style='border-top:none;border-left:none'>필터조건</td>
			  <td colspan='4' class='xl892800' style='border-right:1.0pt solid black;border-left:none'><c:out value="${wishListInfo.filterCon}"/></td>
			 </tr>
