...
var ctgryCd3 = "${searchMap.q_ctgryCd3}";
   ...
   var jsClean = function(){
       ...
       $("#q_goodsTyCd").val("<%=orderManageVO.OM_MT_CD_CT %>").trigger("change");
...
//       /korean/pt/store/inc/BD_storeView.do?goodsCode=
    ...
    var jsOrderView = function(el,seq){
      $(el).colorbox({
          title : "신청내용",
          href : "/${_pathLang}/pt/popup/PD_reqstCnView.do?purchsNo=" + seq,
          width : "500",
          height: "600",
          iframe: true
      });
    ...
    var jsExcelList = function() {
        $("#q_excel").val("13");
        location.href = "BD_cnslList.do?" + $("#dataForm").serialize();
        $("#q_excel").val("");
    };
</script>
</head>
				...
				<td>
					...
					<div class="select-area">
						...
						<div class="sech_form">
							<div class="cont_wrap">
							<div class="selected">
									<div class="select mr15" style="float:left;width:140px;">
										<select id="q_ctgryCd1" name="q_ctgryCd1" title="카테고리1" onchange="jsCtgryList(2,this.value)"  style="width:120px;z-index:5">
        ...
        <op:pagerParam page="param/webListPagerParam.jsp" />
			  ...
			  <div class="type-list">
			      ...
			      <caption>
			          ...
			          <details>
			              <summary>번호, 구매번호, 주문일시, 서비스명, 언어, 이용자, 신청내용, 처리 정보를 제공합니다.</summary>
			          </details>
			      </caption>
			      	<colgroup>
			      ...
			      <tbody>
			            ...
			            <c:forEach items="${pager.list}" var="baseVo" varStatus="status">
			               <tr>
			                    ...
			                    <td class="title"><a href="#javascript:" onclick="jsGoodsView(${baseVo.goodsCd},'')"><c:out value='${baseVo.goodsNm}'/></a></td>
			                    <td><a href="#javascript:" onclick="jsGoodsView(${baseVo.goodsPc},'')"><c:out value='${baseVo.goodsPc}'/></a></td>
			                    <td>
			                        <span><a href="#javascript:" onclick="jsRegistView(this,'${baseVo.ordrrId}')"><c:out value='${baseVo.ordrrNm}'/></a></span>
			                        <span>(${baseVo.ordrrId})</span>
			                    </td>
			                    <td>
			                        <c:if test="${baseVo.sleMthdCd eq omTyCdDw}">
			                          <c:if test="${not empty baseVo.goodsDwldUrl}">
			                            <a href="#" onclick="jsSourceDwon('${baseVo.goodsDwldUrl}','${baseVo.goodsDwldNm}');"><button class="blue" type="button">다운로드</button></a>
			                          </c:if>
			                        </c:if>
