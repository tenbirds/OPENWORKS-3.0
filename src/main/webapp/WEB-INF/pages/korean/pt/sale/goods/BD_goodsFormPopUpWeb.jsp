		...
		<div id="serviceRegist01">
			...
			<table class="tbl_st5" border="1" >
		        ...
		        <tbody>			
					...
					<tr>
						<th>과금기준</th>
						<td>${specInfo.dueStdrMumm}</td>
						<td>${specInfoTmp.dueStdrMumm}</td>
					</tr>
					<tr>
						<th>서비스 가격</th>
						<td>${specInfo.svcPcUntCd} / <fmt:formatNumber  value='${specInfo.svcPc}' type="number"/> / 부가세포함 : ${specInfo.svcPcVat}  </td>
						<td>${specInfoTmp.svcPcUntCd} / <fmt:formatNumber  value='${specInfoTmp.svcPc}' type="number"/> / 부가세포함 : ${specInfoTmp.svcPcVat} </td>
					</tr>
					<tr>
						<th>최소 계약기간</th>
						<td>${specInfo.mummCntrctpd}</td>
						<td>${specInfoTmp.mummCntrctpd}</td>
					</tr>
					<tr>
						<th>서비스 대표 이미지</th>
						<td>
		...
		<div id="serviceRegist01">
			<table class="tbl_st5" border="1" >
		        ...
		        <tbody>
					...
					<tr>
						<td>
							<textarea name="cfmItemContent" id="cfmItemContent"  disabled>${goodsInfoTmp.cfmItemContent}</textarea>						
						</td>
					</tr>
				</tbody>
			</table>	
