...
<head>
	...
	<title>클라우드스토어 씨앗 - 커뮤니티 운영자</title>
...
<body>
	...
	<div id="wrap">
		...
		<header>
			<div id="header">
				...
				<nav id="gnb">
					<ul>
						<!-- 이전소스 -->
						<!-- <li><a href="http://<c:out value='${SubDomain}'/>.ceart.kr/<c:out value='${SubDomain}'/>/pt/store/premium/BD_index.do">표준프레임워크호환</a></li> -->
						<!-- <li><a href="http://<c:out value='${SubDomain}'/>.ceart.kr/<c:out value='${SubDomain}'/>/pt/store/solution/BD_index.do">솔루션/서비스</a></li> -->
						<!-- <li><a href="http://<c:out value='${SubDomain}'/>.ceart.kr/<c:out value='${SubDomain}'/>/pt/store/cnsl/BD_index.do">IT전문가서비스</a></li> -->
						<!-- 20150811 운영팀 요청으로 비즈매칭 주석처리 시작 -->
						<!--li><a href="http://<c:out value='${SubDomain}'/>.ceart.kr/web/board/BD_board.list.do?domainCd=2&bbsCd=1010">비즈매칭</a></li-->
						<!-- 20150811 운영팀 요청으로 비즈매칭 주석처리 끝 -->
						<!-- <li><a href="http://<c:out value='${SubDomain}'/>.ceart.kr/web/board/BD_board.list.do?domainCd=2&bbsCd=1001">공지사항</a></li> -->
						<!-- <li><a href="http://<c:out value='${SubDomain}'/>.ceart.kr/web/board/BD_board.list.do?domainCd=2&bbsCd=1002">고객센터</a></li> -->
				...
				<div class="account">
					<c:if test="${empty sessionScope['__usk']}">
						<a href="/<c:out value='${SubDomain}'/>/pt/login/user/BD_index.do" class="name">LOGIN</a>
					</c:if>
		...
		<!-- footer -->
		<footer>
<!-- 			오픈마켓플레이스 <span class="company">네오소프트 마켓플레이스 플랫폼</span> -->
		</footer>
		<!-- //footer-->
	</div>
