...
<%-- 	
		<form class="sech_form" onsubmit="return false">
			<span onkeydown="javascript:if(event.keyCode == 13){ fn_mainSearch(); return false;}" style="position:relative;">
				<input type="text" placeholder="클라우드서비스 검색" value="${totalKeyword}"  id="totalKeyword" name="totalKeyword" /><a class="btn_search" href="#none">SEARCH</a>
			</span>
			<!-- <input type="search" placeholder="클라우드 서비스 검색" /><a class="btn_search" href="#none">SEARCH</a> -->
		</form>
 --%>		
	</div>
</header>
