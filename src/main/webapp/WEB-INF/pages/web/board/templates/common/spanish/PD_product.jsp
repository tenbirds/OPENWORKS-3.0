...
<!-- 컨텐츠영역 -->
    <div id="pop_wrap">
        <div class="pop_container">
                    ...
                    <dd class="float_l mar_b10 mar_l2" style="float: right;margin-bottom: 10px;">
                        <form id="dataForm" name="dataForm" action="PD_product.do" >
                            ...
                            <input type="hidden" name="chkPurchsNo" id="chkPurchsNo" value="<c:out value='${param.chkPurchsNo}'/>"/>
                                ...
                                <select name="q_searchKeyType" id="q_searchKeyType" title="Búsqueda por nombre de producto" onchange="if($(this).val() != ''){$(this).next().focus().select();}" style="width:115px; margin-left:100px;float: right;">
                                    <option value="GOODS_NM___1009"<c:if test="${param.q_searchKeyType eq 'GOODS_NM___1009'}"> selected="selected"</c:if>>Nombre del producto</option>
                            </select>
                            ...
                            <div class="search" style="float:right; height: 24px; margin-left: 10px;">  
                                ...
                                <input type="text" value="<c:out value='${param.q_searchVal}'/>"  title="Búsqueda por nombre de producto" name="q_searchVal" id="q_searchVal" class="input"  maxlength='50' style="height: 24px;" >
                                <input type="button" class="btn" title="Buscar" onclick="jsSearch(); return false;">
                            </div>
                        </form>
                    </dd>
                </dl>
            ...
            <table  cellspacing="0" border="0" summary="Producto Seleccionar" class="tbl_pop">
                <caption class="hidden">Producto Seleccionar</caption>
                <colgroup>
                    <col width="10%" />
                    <col width="30%" />
                    <col width="45%" />
                ...
                <thead>
                    <tr style="text-align: center;">
                        <th >&nbsp;</th>
                        <th  style="text-align: center;">Número de compra</th>
                ...
                <tbody>
                    ...
                    <c:if test="${empty pager.list}">
                        <tr>
                           <td colspan="3" style="text-align: center;"><strong>No hay datos</strong></td>
                        </tr> 
                    </c:if>
                </tbody>
            </table>
            ...
            <div class="btn_area" style="margin: 0 auto; width: 95px;">
                <div class="btn_navi"><a href="#" onclick="jsProductSubmit(); return false;"><span class="disk">Seleccionar</span></a></div>
            </div>
            <!-- //버튼 -->
