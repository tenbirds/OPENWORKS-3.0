...
<div class="section">
	...
	<div class="type-view">
		<!-- 내용보기 -->
		<table class="tbl_detail_view" summary="홍보영상 상세">
		<caption>홍보영상 상세</caption>
			<colgroup>
				<col style="width:;"/>
				<col style="width:;"/>
		    </colgroup>
		    <thead>
				<tr>
					<th colspan="2" scope="col"><c:out value='${dataVo.bbscttSj}'/></th>
				</tr>
			</thead>
		    <tbody>
		        <tr>		          
		            <td class="al">조회수 <c:out value='${dataVo.rdcnt}'/></td>
