			...
			<div class="contents">
				...
				<div class="section">
								...
								<tr>
									...
									<td>
										<c:if test="${boardConfVo.ctgYn eq 'Y'}">
											<div class="sel_box">
												<!-- select box -->
												<select id="ctgCd" name="ctgCd" title="구분을 선택해주세요" onchange="if($(this).val() != ''){$(this).next().focus().select();}">
				                ...
				                <tr>
									<td colspan="2">
										...
										<c:if test="${boardConfVo.userEditorYn eq 'Y'}" >
				                            <textarea name="bbscttCn" id="bbscttCn" title="내용을 입력해주세요" style="resize:none;">${dataVo.bbscttCn}</textarea>
					...
					<div class="btn-area ar mt20">
						<a href="#" onclick="jsSubmit();" class="btns st1">저 장</a>
						<a href="#" onclick="jsCancel(); return false;" class="btns st1">취 소</a>
					</div>
					<!-- //btn area -->
