...
<head>
	...
	$().ready(function(){
		...
		OpenWorks.banYn			= "${boardConfVo.banYn}";
								...
								<c:if test="${fn:length(dataVo.fileList) > 0}">
									...
									<ul>
										<c:forEach items="${dataVo.fileList}" var="fileVo">
											<li class="mar_b5">
												<a href="#" onclick="jsFileDelete(this, ${fileVo.fileSeq}, '${fileVo.fileId}');"><img src="<c:url value='/resources/web/theme/default/images/icon/icon_del_red.gif'/>" class="vm"></img></a>
