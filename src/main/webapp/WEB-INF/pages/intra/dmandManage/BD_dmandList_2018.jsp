...
//<![CDATA[
    ...
    var jsSearch = function(){
        document.dataForm.action = "BD_dmandList_2018.do";
...
<body>
    <div id="contents">
         <!-- 검색 -->
        <form name="dataForm" id="dataForm" method="get" action="BD_dmandList_2018.do">
            ...
            <tbody id="odd-color">
                ...
                <c:forEach items="${pager.list}" var="baseVo" varStatus="status">
                    <tr>
                        ...
                        <td class="tx_l">${baseVo.bestOrgnCodeNm}</td>
                        <td class="tx_l">${baseVo.orgnNm}</td>
                        <td class="tx_ll">${baseVo.userNm}</td>
                        <td class="tx_ll">${baseVo.userId}</td>
                        <td class="tx_l">${baseVo.dmandsurveyphone}</td>
                        <td class="tx_ll">${baseVo.sumCount}</td>
