...
<body>
    ...
    <div id="popup" style="width:550px;">
        ...
        <div class="mar_b10 clear pop_tab_s">
        	<h2 class="float_l">권한 그룹명 : ${param.authNm}</h2>
            <div class="float_r mar_t5" style="width:150px;text-align:right;">지정권한 : <span class="tx_red tx_b">${dataVo.authMenuAssignCount }</span>건</div>
        </div>
        <!-- 리스트 -->
