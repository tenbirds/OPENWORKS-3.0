...
//     };
    ...
    var jsSearch = function(){
        ...
        $("#dataForm").attr("action", "BD_intrStat.do");
        $("#dataForm").submit();
    };
    ...
    var reportAction = function(){
        ...
        var open = "/report/reporting.jsp?reportSection=1003&q_langCodes="+q_langCodes+"&q_beginDate="+q_beginDate+"&q_endDate="+q_endDate;
...
<body>
    ...
    <div id="contents">
        <!-- 검색 -->
        <form name="dataForm" id="dataForm" method="get" action="BD_intrStat.do">
