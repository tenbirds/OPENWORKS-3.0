...
<div class='search'>
    <fieldset>
        ...
        <label class='tx_b'>
         ...
         <select name="selBoxCd" id="selBoxCd" class="mar_r20">              
              <c:forEach items="${searchMap}" var="codeList">
                  <option value="${codeList.selBoxCd}" 
                       <c:if test="${searchVo.selBoxCd eq codeList.selBoxCd}">selected="selected" </c:if>> 
                       ${codeList.selBoxVl}</option>
               </c:forEach> 
      	  </select>        
