...
<table class='boardList' cellspacing='0' border='0' summary='리스트입니다.'>
    ...
    <thead id='listHead'>
        <tr>
            <th><span id='sortHead1' onclick='sorting("1");'>색상수(Bit)</span></th>
            <th><span id='sortHead2' onclick='sorting("2");'>횟수</span></th>
            <th class='lr_none'><span id='sortHead3' onclick='sorting("3");'>비율</span></th>
        </tr>
    </thead>
    <tbody id='listBody'>
        <c:forEach items='${dataList}' var='data' varStatus='idx'>
            <tr <c:if test='${(idx.count mod 2) eq 0 }'> class='bg_yellow'</c:if>>
                <td title='<c:out value='${data.title }'/>'><c:out value='${data.title }'/> bit</td>
    ...
    <tfoot>
        <tr class='bg_gray'>
            ...
            <td class='tx_r' title='100'>100 %</td>
        </tr>
    </tfoot>
</table>
<!-- //리스트 -->