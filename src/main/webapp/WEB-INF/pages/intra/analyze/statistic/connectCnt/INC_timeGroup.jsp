...
<!-- 검색영역2 -->
<c:import url="../include/INC_search3.jsp" charEncoding="utf-8"/>
...
<table class='boardList' cellspacing='0' border='0' summary='리스트입니다.'>
    ...
    <thead id='listHead'>
        <tr>
            ...
            <th><span id='sortHead2' onclick='sorting("2");'>방문자</span></th>
            <th><span id='sortHead3' onclick='sorting("3");'>비율</span></th>
        </tr>
    </thead>
    <tbody id='listBody'>
        <c:forEach items='${dataList}' var='data' varStatus='idx'>
            <tr <c:if test='${(idx.count mod 2) eq 0 }'> class='bg_yellow'</c:if>>
                ...
                <td class='tx_r lr_none' title='<c:out value='${data.rateValue}'/>'>
                    <c:out value='${data.rateValue}'/>%
                </td>
            </tr>
        </c:forEach>
