...
<table class='boardList' cellspacing='0' border='0' summary='리스트입니다.'>
    ...
    <thead id='listHead'>
        <tr>
            ...
            <th><span id='sortHead3' onclick='sorting("3");'>순 방문수</span></th>
            <th><span id='sortHead4' onclick='sorting("4");'>재 방문수</span></th>
    ...
    <tfoot>
        <tr class='bg_gray'>
            ...
            <td class='tx_r' title='<c:out value='${dataVo.value }'/>'><c:out value='${dataVo.value2 }'/></td>
            <td class='tx_r' title='<c:out value='${dataVo.value }'/>'><c:out value='${dataVo.value3 }'/></td>
