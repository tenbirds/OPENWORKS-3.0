...
<body style="min-width:670px">
	...
	<div id="popup">
		...
		<div class="blue_box_tx">
			...
			<dl class="clear">
				<dt class="float_l mar_r5"><strong><label for="sido">ㆍ시도 </label></strong></dt>
				<dd class="float_l mar_r5">
					<select id="q_sidoCd" name="q_sidoCd" class="over" title="시도 선택">
				...
				<dd class="float_l mar_b10">
					<input type="text" title="검색어입력" value="${param.q_searchVal}" id="q_searchVal" name="q_searchVal"  class="w215" style="margin-left:43px;"/>
					<span id="idspan1"></span>
					<input type="text" title="검색어입력" value="${param.q_searchBun1}" style="width:50px" size="50" id="q_searchBun1" name="q_searchBun1" />
					- <input type="text" title="검색어입력" value="${param.q_searchBun2}" style="width:50px" size="50" id="q_searchBun2" name="q_searchBun2" />
			...
			<p id="schm1" class="clear mar_l10 mar_b5">* 검색방법</p>
			<p id="schm1" class="clear mar_l20">- 동(읍/면/리)명+지번</p>
			<p id="schm3" class="clear mar_l20 mar_b10"> 서울시 중구 <strong>충무로1가 21-1</strong>&nbsp;&nbsp;예) '<strong>충무로1가</strong>(동명) <strong>21-1</strong>(지번)'</p>
			<p id="schm1" class="clear mar_l20">- 도로명(~로, ~길) + 건물번호</p>
			<p id="schm3" class="clear mar_l20 mar_b10"> 서울시 중구 <strong>소공로 70</strong>&nbsp;&nbsp;예) '<strong>소공로</strong>(도로명) <strong>70</strong>(건물번호)'</p>
			<p id="schm1" class="clear mar_l20">- 시/도 및 시/군/구 선택 후 건물명 입력</p>
			<p id="schm3" class="clear mar_l20 mar_b10"> 서울시 중구 <strong>중앙우체국</strong>&nbsp;&nbsp;예) '<strong>서울</strong>' 및 '<strong>중구</strong>' 선택 후 '<strong>중앙우체국</strong>(건물명)'</p>
		</div>
		
		<table id="ziptable" cellspacing="0" border="0" summary="우편번호" class="boardList">
