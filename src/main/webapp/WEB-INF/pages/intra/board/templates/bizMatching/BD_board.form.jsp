...
<head>
	...
	<op:jsTag type="spi" items="form, validate, multifile, datepicker,ui" />
	...
	$().ready(function(){
		...
		OpenWorks.endDt         = "${param.estnColumn6}";
									...
									<c:when test="${extensionVo.columnTy eq 'TEXT'}">
									   ...
									   <c:choose>
									       <c:when test="${extensionVo.columnId  eq 'ESTN_COLUMN6' }">
									           <input type="text" id="endDt" name="endDt" class="w80" value="${param.endDt}" style="width:207px;"/>
									           <select id="endHH" name="endHH" style="width:88px;" title="종료일 시 선택"  >
									           ...
									           <span class="txt">시</span>
	                                               <select id="endMM" name="endMM" title="종료일 분 선택" style="width:88px;">
