...
<head>
	...
	$().ready(function(){
		...
		OpenWorks.ctgCd   			= "${param.q_ctgCd}";
		OpenWorks.aditCtgCd   	= "${param.q_aditCtgCd}";
		OpenWorks.showSummaryYn	= "N";
	...
	//수정 폼
	var jsUpdateForm = function(pageType, bbscttSeq){
	...
	//삭제
	var jsDelete = function(bbscttSeq){
    ...
    var jsSearchReset2 = function(){
        self.location.href = "BD_board.list.do?domainCd=2&bbsCd=1002";
    };
