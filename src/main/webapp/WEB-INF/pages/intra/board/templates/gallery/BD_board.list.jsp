...
<head>
	...
	// 게시판 글 사용 여부 설정
	var jsothbcAtAction = function(el, domainCd, bbsCd, bbscttSeq) {
	    var element = $(el).children();
	    var othbcAt = element.attr("yn") == "Y" ? "N" : "Y";
	    element.text("....");

	    $.post("ND_othbcAtUpdateAction.do", {
	        domainCd : domainCd,
	        bbsCd : bbsCd,
	        bbscttSeq : bbscttSeq,
	        othbcAt : othbcAt
	...
	<form name="dataForm" id="dataForm" method="get" onsubmit="return jsSearch();">
		...
		<div>
			<div class="float_l">
				...
				<button type="button" class="w_blue mar_l5" onclick="jsSummaryShow();">SUMMARY1</button>
			</div>
			<div class="float_r">
