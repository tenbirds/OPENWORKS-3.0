		...
		<table class="boardWrite" border="0" cellspacing="0" cellpadding="0" summary="글 내용을 표시">
			...
			<tbody>
				...
				<tr>			
					<th colspan="2" class="tx_c">
						...
						<input type="checkbox" name="noticeBbscttAtYn" id="noticeBbscttAtYn" value="Y" class="checkbox" /><label for="noticeBbscttAtYn">&nbsp;공지 표시</label>
					</th>
				</tr>
				<tr>
					<th>검색 건수</th>
			...
			<tbody id="tbodyOpt">
				...
				<tr id="optGrp1">
					...
					<td>
						<input type="checkbox" name="bbscttSjYn" id="bbscttSjYn" value="Y" class="checkbox" /><label for="bbscttSjYn">&nbsp;제목</label>
						<input type="checkbox" name="cnSummaryYn" id="cnSummaryYn" value="Y" class="checkbox" /><label for="summaryYn">&nbsp;내용요약</label>
					</td>
				</tr>
				<tr id="optGrp2">
					<th><input type="checkbox" name="optAll2" id="optAll2" value="Y" class="checkbox" /><label for="optAll2">&nbsp;모두선택</label></th>
					<td>
						<input type="checkbox" name="registDtYn" id="registDtYn" value="Y" class="checkbox" /><label for="registDtYn">&nbsp;등록일</label>
						<input type="checkbox" name="updtDtYn" id="updtDtYn" value="Y" class="checkbox" /><label for="updtDtYn">&nbsp;수정일</label>
						<input type="checkbox" name="rdcntYn" id="rdcntYn" value="Y" class="checkbox" /><label for="rdcntYn">&nbsp;조회수</label>
					</td>
				</tr>
				<tr id="optGrp3">
					<th><input type="checkbox" name="optAll3" id="optAll3" value="Y" class="checkbox" /><label for="optAll3">&nbsp;모두선택</label></th>
					<td>
						<input type="checkbox" name="registerNmYn" id="registerNmYn" value="Y" class="checkbox" /><label for="registerNmYn">&nbsp;작성자이름</label>
						<input type="checkbox" name="mngrIdYn" id="mngrIdYn" value="Y" class="checkbox" /><label for="mngrIdYn">&nbsp;매니저ID</label>
				...
				<tr id="optGrp4" class="no-btm">
					...
					<td>
						...
						<input type="checkbox" name="recomendCntYn" id="recomendCntYn" value="Y" class="checkbox" /><label for="recomendCntYn">&nbsp;추천수</label>
					</td>
				</tr>
			</tbody>
		</table>
