...
<head>
    ...
    $().ready(function(){
        ...
        OpenWorks.aditCtgCd   	= "${param.q_aditCtgCd}";
    ...
    var jsSearchReset2 = function(){
        self.location.href = "BD_board.list.do?domainCd=2&bbsCd=${param.bbsCd}";
    };

    
	//2depth 조회
	function aditCtgSel(){
	    var ctgCd = $("#q_ctgCd option:selected").val();
	    $.ajax({
            ...
            success: function(datalist) {
                ...
                if(datalist.length > 0) {
                    ...
                    selectString += "<select id='q_aditCtgCd' name='q_aditCtgCd' title='분류를 선택해주세요'>";
...
<!--                 <button type="button" class="w_blue mar_l5" onclick="jsConvertAction('atom');">ATOM</button> -->
            ...
            <div class="float_r"> 
                ...
                <c:if test="${MenuAssignType eq 'G' or MenuAssignType eq 'R'}">
