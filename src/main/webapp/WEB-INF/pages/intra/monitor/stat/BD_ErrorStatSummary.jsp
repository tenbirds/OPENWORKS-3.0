...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            // 처리상태현황
            $("#procStatDiv").load("/intra/monitor/stat/INC_ErrorProcStat.do", param, function() {
            });

            param["q_title"] = "처리기간현황";
            // 처리기간현황
            $("#termStatDiv").load("/intra/monitor/stat/INC_ErrorTermStat.do", param, function() {
            });

            param["q_title"] = "담당자별현황";
            // 담당자별현황
            $("#tranStatDiv").load("/intra/monitor/stat/INC_ErrorTranStat.do", param, function() {
            });

            param["q_title"] = "기간준수현황";
            // 기간준수율
            $("#observeStatDiv").load("/intra/monitor/stat/INC_ErrorObserveStat.do", param, function() {
            });
        });
...
<body>
    ...
    <!-- 검색 -->
    <form name="dataForm" id="dataForm" method="get" action="BD_ErrorStatSummary.do">
