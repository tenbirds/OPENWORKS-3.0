...
<%@ taglib uri="http://www.openworks.kr/jsp/jstl" prefix="op"%>
    ...
    <script type="text/javascript">
        ...
        <c:forEach items="${dataList}" var="dataVo" varStatus="status">
            procChartXml += "    <set value='${dataVo.stat01}' name='미배정'/>";
            procChartXml += "    <set value='${dataVo.stat02}' name='배정'/>";
            procChartXml += "    <set value='${dataVo.stat03}' name='처리중'/>";
            procChartXml += "    <set value='${dataVo.stat04}' name='완료'/>";
        </c:forEach>
