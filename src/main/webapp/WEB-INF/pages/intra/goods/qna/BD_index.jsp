...
var ctgryCd3 = "<c:out value='${searchMap.q_ctgryCd3}' />";
  ...
  var jsGoodsView = function(seq,urlNm,lang){
    ...
    var jsView = function(el,no){

      $(el).colorbox({
        title : "문의내역",
        href  : "PD_goodsQnAPop.do?goodsInqryNo=" + no,
        width : "900",
        height: "500",
        iframe: true
      });
    ...
    <div id="contents">
                        ...
                        <table class="boardWrite" cellspacing="0" border="0" summary="검색 조건">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>상태</th>
                                    <td colspan="3">
                                        <op:code id="q_answerSttusCd" grpCd="1012" defaultValues="${searchMap.q_answerSttusCd}" type="select" defaultLabel="전체"  />
                                    </td>
                                </tr>
                                <tr>
                                    <th>등록일</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3">
                                      <select id="q_searchKey" name="q_searchKey" title="상세검색을 선택하세요">
                                        ...
                                        <option value="1002" <c:if test="${searchMap.q_searchKey == '1002'}">selected="selected"</c:if>>문의제목</option>
                                        <option value="1003" <c:if test="${searchMap.q_searchKey == '1003'}">selected="selected"</c:if>>작성자</option>
                                        <option value="1004" <c:if test="${searchMap.q_searchKey == '1004'}">selected="selected"</c:if>>상점명</option>
                                      </select>
        ...
        <table class="boardList" cellspacing="0" border="0" summary="리스트입니다.">
            ...
            <thead>
                ...
                <th>공개여부</th>
                <th>상점명<br/>(판매자ID)</th>
                <th class="lr_none">문의일자<br/>답변일자</th>
            </thead>
            <tbody id="odd-color">
                ...
                <c:forEach items="${pager.list}" var="baseVo" varStatus="status">
                  <tr>
                    ...
                    <td>
                      <div class="tx_l">
                        <a href="javascript:" onclick="jsView(this,'<c:out value="${baseVo.goodsInqryNo}" />','<c:out value="${baseVo.answerSttusCd}" />')"><c:out value="${baseVo.inqrySj}" /></a>                        
                      </div>
                    </td>
                    <td>
                      <a href="javascript:" onclick="jsUserView(this,'<c:out value="${baseVo.inqrId}" />')"><span > <c:out value="${baseVo.inqrNm}" /> </span></a><br />                      
                    ...
                    <td>
                      <a href="javascript:" onclick="jsStoreView(this,'<c:out value="${baseVo.userId}" />')"><span > <c:out value="${baseVo.langStoreNm}" /> </span></a><br />
                      <span > (<c:out value="${baseVo.userId}" />) </span>
                    </td>
                    <td>
                      <span ><c:out value="${baseVo.inqryDt}" /> </span><br />
                      <span ><c:out value="${baseVo.answerDt}" /> </span>
                    </td>
                  </tr>
                </c:forEach>
