...
<div id="contents">
    ...
    <div class="mar_t30">
        <ul class="blet">
            ...
            <li><span class="tx_b">사용 불가한 비밀번호</span> : 현재 비밀번호, 이전 비밀번호
            	<br/><span style="margin-left:125px;">&nbsp;&nbsp;&nbsp;아이디/이메일/전화번호/휴대폰번호/생년월일 포함, 동일한 숫자/연속된 숫자 4번 이상 포함</span></li>
        </ul>
    </div>
