...
<!-- 컨텐츠영역 -->
	...
	<!-- 기본정보 -->
		<h2 class="mar_t20">커뮤니티 폐쇄 상세</h2>
		<fieldset>
			...
			<tbody>
          	<tr>
				...
				<tr>
					...
					<td><span>
						<c:if test="${openCmManageView.langCode != '00'}">http://<c:out value='${fn:toLowerCase(openCmManageView.langEngNm)}'/>/cm/user/<c:out value='${openCmManageView.cmmntyUrl}'/></c:if>
                    	<c:if test="${openCmManageView.langCode == '00'}">http://<c:out value='${openCmManageView.cmmntyUrl}'/></c:if></span></td>
					<th>커뮤니티 카테고리</th>
				...
				<tr>
					<th><span>커뮤니티 <br/> 폐쇄 사유</span></th>
					<td colspan="3"><span>
					<c:out value="${openCmManageView.cmmntyClsResn}"/>
					</span></td>
				</tr>
        		</tbody>
         	</table>
