...
<head>
    ...
    var getData = function (idx) {
        var fileds = ['application','cancel','month'];
        var data = [new Array()];
        ...
        <c:forEach items="${dataList0}" var="data0">
            data[0].push({
                ...
                month : '<c:out value="${data0.month}"/> 월'
            });
        </c:forEach>
...
<form name="dataForm" id="dataForm" method="get" action="BD_month.do">
<div id="contents">
    <div>
    <ul class="tab_s">
        <li><a href="<c:url value="../status/BD_index.do" />">년도별 마일리지 통계</a></li>
        <li class="on"><a href="<c:url value="../status/BD_month.do" />">월별 마일리지 통계</a></li>
