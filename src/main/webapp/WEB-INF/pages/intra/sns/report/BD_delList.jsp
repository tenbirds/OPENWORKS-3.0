...
<script type="text/javascript">
    ...
    var jsSearch = function() {
        ...
        document.dataForm.action = "BD_delList.do";
    ...
    //선택복원
    var jsRestoreChoose = function() {
        
        var cnt = $('input.chk_seq:checked').length;        
		
        if(cnt == 0) {            
            jsWarningBox("복원할 댓글을 선택해 주세요");
            return;
        }        
...
<body>
	<div id="contents">
		...
		<input type="hidden" id="q_searchDel_yn1" name="q_searchDel_yn1" value="N" />
			...
			<div class="search">
				<fieldset>
					...
					<button class="s_blue mar_l5 mar_b5" type="button"	onclick="jsRestoreChoose();">선택 복원</button>
			...
			<!-- 탭 -->
			<ul class="tab">
				<li><a href="BD_index.do"                /> 댓글목록</a></li>
			    <li><a href="BD_delList.do"  class="on"  /> 삭제목록</a></li>			    		    
			</ul>
			<!-- //탭 -->		
		
			<!-- 페이지당 목록선택-->
			<op:pagerParam title="삭제 댓글목록" />
		</form>
