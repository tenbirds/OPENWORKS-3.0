...
<html lang="ko">
<head>
    <title>IT전문가서비스 검토 상세조회/수정</title>
...
//                                 htmlEncodeOutput : true,
    ...
    <div class="mar_t20 mar_b50">
        <div class="float_l">
            <input type="button" value="목록" class="blue" onclick="jsList('BD_cnslExmntList.do');" />
        ...
        <div class="float_r">
            ...
            <input type="button" value="검토완료" class="blue" onclick="jsGoodsUpdateAction('1004','ND_cnsltExmntUpdate.do');" />
            <input type="button" value="즉시승인" class="blue" onclick="jsGoodsUpdateAction('1007','ND_cnsltExmntUpdate.do');" />
        </div>
    </div>
    <!-- //버튼 -->
    </form>
