...
//             }
    ...
    var jsView = function(vl){
        $("#goodsCode").val(vl);
        document.dataForm.action = "BD_cnslConfnDetail.do";
        document.dataForm.submit();
    };

    var jsSearch = function(){
//        document.dataForm.action = "BD_cnslConfnList.do";
        document.dataForm.elements["q_currPage"].value = "1";
        document.dataForm.elements["q_init"].value = "0";
//         document.dataForm.submit();
        $("#dataForm").attr("action", "BD_cnslConfnList.do");
        $("#dataForm").submit();
    };
...
<body>
    <div id="contents">
        <!-- 검색 -->
        <form name="dataForm" id="dataForm" method="get" action="BD_cnslConfnList.do">
...
<!--                                 </td> -->
            ...
            <op:pagerParam title="IT전문가서비스 승인대기 목록" />
...
<!--                         </td> -->
                        ...
                        <td>${baseVo.exmntConfmDt}<br/>${baseVo.confmLimitDt}</td>
