        ...
        $("span#registPeriod2  a  button.gray").click(function(){
            ...
            switch(sType){
                ...
                case '3M2':
                    ...
                    break;
                default:
                    $("#q_beginDate2").val("2000-01-01");
                    $("#q_endDate2").val("2100-12-31");
                    break;
            }
            $('#q_beginDate2').val(getDateStr(q_beginDate));
...
//             }
        ...
        $("#q_beginDate, #q_beginDate2").keyup(function(event){
            if (!(event.keyCode >=37 && event.keyCode<=40)) {
                var inputVal = $(this).val();
                $(this).val(inputVal.replace(/[^a-z0-9\-]/gi,''));
            }
        });
        $("#q_endDate, #q_endDate2").keyup(function(event){
            if (!(event.keyCode >=37 && event.keyCode<=40)) {
                var inputVal = $(this).val();
                $(this).val(inputVal.replace(/[^a-z0-9\-]/gi,''));
            }
...
<!-- 기능별 스크립트 정의 -->
    ...
    var jsView = function(vl){
        $("#goodsCode").val(vl);
        document.dataForm.action = "BD_cnslDetail.do";
...
//         document.dataForm.submit();
        $("#dataForm").attr("action", "BD_index.do");
        $("#dataForm").submit();
    };
...
<!--                                 </td> -->
                            ...
                            <tr>
                                <th>최초승인일</th>
                                <td colspan="3">
                                    <input class="w120" type="text" name="q_beginDate2" id="q_beginDate2" title="시작날짜선택" maxlength="10" style="ime-mode:disabled;"<c:if test="${not empty param.q_beginDate2}"> value="${param.q_beginDate2}"</c:if>/> ~
                                    <input class="w120" type="text" name="q_endDate2" id="q_endDate2" title="종료날짜선택" maxlength="10"<c:if test="${not empty param.q_endDate2}"> value="${param.q_endDate2}"</c:if>/>
                                    <span class="mar_l10" id="registPeriod2">
                                        <a href="javascript:;"><button type="button" id="02"   class="gray">오늘</button></a>
                                        <a href="javascript:;"><button type="button" id="7D2"   class="gray">일주일</button></a>
                                        <a href="javascript:;"><button type="button" id="1M2"   class="gray">1개월</button></a>
                                        <a href="javascript:;"><button type="button" id="3M2"   class="gray">3개월</button></a>
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <th>전시 유무</th>
                                <td>
                                    <op:code id="q_goodsRegistSttus" grpCd="1008" ctgCd="DSPYN" defaultValues="${param.q_goodsRegistSttus}" type="select" defaultLabel="전체"  />
                                </td>
<!--                                 <th>인증 구분</th> -->
<!--                                 <td> -->
...
<!--                                 </td> -->
            ...
            <op:pagerParam title="IT전문가서비스 전체 목록" />
...
<!--         <form name="dataForm2" id="dataForm2" method="post"> -->
            ...
            <tbody id="odd-color">
                ...
                <c:forEach items="${pager.list}" var="baseVo" varStatus="status">
                    <tr>
                        ...
                        <td>
                            ${baseVo.goodsCode}<br/>(${baseVo.langNm})
                        </td>
                        <td>
                            <div class="tx_l">
                        ...
                        <td class="tx_r">
                            <fmt:formatNumber value="${baseVo.goodsPc}" type="NUMBER" groupingUsed="true"/>
                        </td>
                        ...
                        <td>${baseVo.exmntConfmDt}<br/>${baseVo.confmDt}</td>
                    </tr>
                </c:forEach>
        ...
        <div>
            <div class="float_l">
                <a href="javascript:;" onclick="jsDspy(1006);"><button class="w_blue" type="button">선택항목 전시</button></a>
                <a href="javascript:;" onclick="jsDspy(1007);"><button class="w_blue" type="button">선택항목 비전시</button></a>
            </div>
            <div class="float_r">
