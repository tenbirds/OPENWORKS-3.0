...
<!-- 기능별 스크립트 정의 -->
    ...
    var jsView = function(vl){
        $("#goodsCode").val(vl);
        document.dataForm.action = "BD_cnslExmntDetail.do";
        document.dataForm.submit();
    };

    var jsSearch = function(){
//        document.dataForm.action = "BD_cnslExmntList.do";
        document.dataForm.elements["q_currPage"].value = "1";
        document.dataForm.elements["q_init"].value = "0";
//         document.dataForm.submit();
        $("#dataForm").attr("action", "BD_cnslExmntList.do");
        $("#dataForm").submit();
    };
...
//	             url += "eventSeqs=" + strObj[0] + "&fileIds=" +  strObj[1] + "&" ;
    ...
    var jsRegistBack = function(el, goodsCode) {
        ...
        $(el).colorbox({
            title : "승인반려사유보기",
            href : "/korean/pt/sale/goods/PD_returnReasonPop.do?goodsCode="+goodsCode+"&exmntConfmCd=1005",
            width : "700",
            height : "400",
            overlayClose : false,
            escKey : false,
...
<body>
    <div id="contents">
        <!-- 검색 -->
        <form name="dataForm" id="dataForm" method="get" action="BD_cnslExmntList.do">
...
<!--                                 </td> -->
            ...
            <op:pagerParam title="IT전문가서비스 검토대기 목록" />
