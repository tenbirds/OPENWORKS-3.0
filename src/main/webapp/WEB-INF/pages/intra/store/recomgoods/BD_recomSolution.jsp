...
//         jsSelected("q_searchKey", "${param.q_searchKey}");
    ...
    var jsSearch = function(){
        document.dataForm.action = "BD_recomSolution.do";
    ...
    var jsRecomDelete = function(inputNm) {
     ...
     var jsApply = function(lc, ty, inputNm) {
         //  var url = "ND_recomInsertAction.do";
             ...
             if(confirm("추천 솔루션/서비스를 적용 하시겠습니까?")){
                jQuery.ajaxSettings.traditional = true;
                if (inputNm == "recomGoodsCodes1") {
                    $.ajax({
     ...
     var jsLangChange = function (langCode) {
         $("#q_init").val("0");
         self.location.href = "BD_recomSolution.do?q_langCodes="+langCode;
     };
    ...
    <div id="contents">
        ...
        <form name="dataForm" id="dataForm">
            ...
            <ul style="margin-bottom: 0px;">
                ...
                <li id="infoTab3" style="width:200px;"><a href="javascript:;" ><span>솔루션/서비스 추천서비스</span></a></li>
            ...
            <div class="mar_t20">
            <h4>솔루션 추천서비스 (최대 10개)</h4>
            <table class="boardList" cellspacing="0" border="0" summary="솔루션 추천서비스">
            ...
            <tbody>
                <c:set var="index" value="${recomSubS.indexNo}"/>
                <c:forEach items="${recomSubS.list}" var="baseVo" varStatus="status">
                    <tr>
                ...
                <op:no-data obj="${recomSubS}" colspan="10" />
            </tbody>
            </table>
            <div><button type="button" class="blue mar_t5" onclick="jsRecomDelete('recomGoodsCodes1');">추천 솔루션/서비스 추천서비스 해제</button>
                 <button type="button" class="blue mar_t5 float_r" onclick="jsApply(1002, 1002, 'recomGoodsCodes1');">추천 솔루션/서비스 적용</button>
            </div>
            </div>
                    ...
                    <table class="boardWrite" cellspacing="0" border="0" summary="검색 조건">
                        ...
                        <tbody>
                            <tr>
                                <th>카테고리</th>
                                <td colspan="3">
                                    <op:code id="q_goodsTyCd" grpCd="1005" ctgCd="SLTNCD" defaultValues="1002" type="select" defaultLabel="구분" onchange="jsCtgryList(1,null)" />
...
<!--         <form name="dataForm2" id="dataForm2" method="post"> -->
            <table class="boardList" cellspacing="0" border="0" summary="솔루션">
            <caption class="hidden"> 목록 </caption>
            <colgroup>
                <col width="5%"/>
                <col width="3%"/>
        ...
        <div>
	        <div class="tx_c">
	             <a href="javascript:;" onclick="jsRecom(1002, 1002, 'recomGoodsCodes1');"><button class="w_blue mar_l10" type="button">선택항목 추천 솔루션/서비스</button></a>
	        </div>
        </div>
        <!--  //버튼 -->
    </form>
