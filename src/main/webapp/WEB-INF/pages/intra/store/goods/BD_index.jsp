                              ...
                              <%-- <tr>
                                ...
                                <td>
                                    <p class="mar_t5" id="langCheck">
                                        ...
                                        <c:if test="${fn:length(param.q_langCodes) == 0}">checked="checked"</c:if> />전체
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="q_gtwobChk" name="q_gtwobChk" title="상세검색을 선택하세요">
	                            		<option <c:if test="${param.q_gtwobChk == ''}">selected="selected"</c:if> value="">전체</option>
	                            		<option <c:if test="${param.q_gtwobChk == '1001'}">selected="selected"</c:if> value="1001">등록</option>
	                            		<option <c:if test="${param.q_gtwobChk == '1002'}">selected="selected"</c:if> value="1002">미등록</option>
                                    </select>
                                </td>                              
                            </tr>
                        </tbody>
