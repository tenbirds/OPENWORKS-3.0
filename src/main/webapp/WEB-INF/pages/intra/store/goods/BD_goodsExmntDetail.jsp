    ...
    <script type="text/javascript" src="<c:url value="/resources/intra/store/goods.js" />"></script>
	    ...
	    var jsAsIsViewPop = function(el, goodsCode) {
            $(el).colorbox({
                ...
                href : "BD_goodsExmntDetail_v2.do?goodsCode="+goodsCode,
                width : "900",
                height : "550",
                iframe : true
            });
...
<body>
    ...
    <input type="hidden" id="goodsNum" name="goodsNum" value="${specVo.goodsNum}" />
    <input type="hidden" id="formNm" name="formNm" value="dataForm" />
    <input type="hidden" name="exmntConfmHistSn" id="exmntConfmHistSn" value="${dataVo.exmntConfmHistSn}" />
 
    <table class="w_100p mar_b5">
			<tr>
				<td class="tx_l">
<c:if test="${dataVo.goodsRegistSttus < 1008}">
		      	<c:if test="${dataVo.goodsRegistSttus == 1002  or dataVo.goodsRegistSttus == 1005 }">
		        	<input type="button" value="신청자에게 반려" class="blue" onclick="jsRegistBack(this, 1003);" />
		        </c:if>
		        <c:if test="${dataVo.goodsRegistSttus == 1009}">
		        <input type="button" value="신청자에게 반려" class="blue" onclick="jsRegistBack(this, 1010);" />
		        </c:if>
		        <c:if test="${dataVo.goodsRegistSttus == 1002 or dataVo.goodsRegistSttus == 1005 }">
		        <input type="button" value="검토완료" class="blue" onclick="jsRegistBack(this, 1004);" />
		        </c:if>
		        <c:if test="${dataVo.goodsRegistSttus != 1002 and dataVo.goodsRegistSttus != 1005}">
		        <input type="button" value="즉시승인" class="blue" onclick="jsGoodsUpdateAction('1007','ND_goodsExmntUpdate.do', 'C', 'dataForm');" />
		        </c:if>
</c:if>
        ...
        <td class="tx_r">
		      <div class="float_r">
		         ...
		         <!-- <input type="button" value="검토반려" class="blue" onclick="jsRegistBack(this, 1003);" /> -->
			        <input type="button" value="목록" class="blue" onclick="jsList('BD_goodsExmntList.do');" />
			        <input type="button" value="삭제" class="blue" onclick='jsDeleteConfirm(this);' />
		          <input type="button" value="수정완료" class="blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BB', 'dataForm');" />
		      </div>
        </td>
    	</tr>
    </table>
...
<!-- 서비스 기본정보 -->
				<tr>
					<td colspan="2">
						<h4>서비스 일반 정보&nbsp;&nbsp;
							<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm1');" />
						</h4>
					</td>
				</tr>
				<!-- 서비스명 -->
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
	    ...
	    <tbody>
	    	<tr>
	    		<td colspan='2'>
	    			<h4>상세 정보&nbsp;&nbsp;
	    				<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm2');" />
	    			</h4>
	    		</td>
	    	</tr>
        <tr>
	    ...
	    <tbody>
	    	<tr>
	    		<td colspan='2'>
	    			<h4>
	    				서비스 사양 정보&nbsp;&nbsp; 
	    				<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm3');" />
	    			</h4>
	    		</td>
	    	</tr>
				<!-- 서비스 관리 기준-->
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>
      				서비스 인증 정보&nbsp;&nbsp;
      				<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm4');" />&nbsp;&nbsp;
...
<form name="dataForm5" id="dataForm5" method="post">
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>서비스 기술정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm5');" /></h4>
      		</td>
      	</tr>
      	<tr>
...
<form name="dataForm6" id="dataForm6" method="post">
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>서비스 및 데이터관리 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm6');" /></h4>
      		</td>
      	</tr>
      	<tr>
...
<form name="dataForm7" id="dataForm7" method="post">
    ...
    <input type="hidden"	id="userMnlInfoInput"	name="userMnlInfoInput" value="${specVo.userMnlInfoInput}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>서비스지원 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm7');" /></h4>
      		</td>
      	</tr>
      	<tr>
...
<form name="dataForm8" id="dataForm8" method="post">
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="3">
      			<h4>소프트웨어형 서비스(SaaS) 관련 규격정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm8');" /></h4>
      		</td>
      	</tr>
      	<tr>
...
<!-- 플랫폼형 서비스(Paas) 관련 규격 정보-->
      ...
      <tbody>
      	<tr>
      		<td colspan="3">
      			<h4>플랫폼형 서비스(Paas) 관련 규격 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm9');" /></h4>
      		</td>
      	</tr>
      	<tr>
      		<th rowspan="2">서비스 제공 방식</th>
...
<!-- 인프라형 서비스(IaaS) 관련 규격 정보 -->
      ...
      <tbody>
      	<tr>
      		<td colspan="3">
      			<h4>인프라형 서비스(IaaS) 관련 규격 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm10');" /></h4>
      		</td>
      	</tr>			
				<tr>
					<th>공개표준지원</th>
...
<!-- 컨설팅 서비스 (SCS) 관련 규격 정보 -->
      ...
      <tbody>
      	<tr>
      		<td colspan="3">
      			<h4>컨설팅 서비스 (SCS) 관련 규격 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm11');" /></h4>
      		</td>
      	</tr>			
        <tr>
...
<form name="dataForm12" id="dataForm12" method="post">
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>제공자 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm12');" /></h4>
      		</td>
      	</tr>
      	<tr>
...
<form name="dataForm13" id="dataForm13" method="post">
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>서비스 담당자 정보&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm13');" /></h4>
      		</td>
      	</tr>
        <tr>
...
<form name="dataForm14" id="dataForm14" enctype="multipart/form-data" method="post">
    ...
    <input type="hidden" id="langCode" 					name="langCode" 				value="${dataVo.langCode}" />
      ...
      <tbody>
      	<tr>
      		<td colspan="2">
      			<h4>가격표 및 첨부파일&nbsp;&nbsp;<input type="submit" value="임시저장" class="w_blue" onclick="jsGoodsUpdateAction('','ND_goodsIndexUpdate.do', 'BC', 'dataForm14');" /></h4>
      		</td>
      	</tr>
				<tr>
...
<c:if test="${dataVo.goodsRegistSttus < 1008}">
          ...
          <c:if test="${dataVo.goodsRegistSttus != 1002 and dataVo.goodsRegistSttus != 1005}">
          <input type="button" value="즉시승인" class="blue" onclick="jsGoodsUpdateAction('1007','ND_goodsExmntUpdate.do', 'dataForm');" />
          </c:if>
</c:if>
        </div>
        <c:if test="${dataVo.goodsRegistSttus < 1008}">
