...
<body>
    ...
    <input type="hidden" name="exmntConfmHistSn" id="exmntConfmHistSn" value="${dataVo.exmntConfmHistSn}" />
      ...
      <div class="float_r">
          ...
          <c:if test="${dataVo.goodsRegistSttus == 1002 or dataVo.goodsRegistSttus == 1005 }">
          <input type="button" value="검토완료" class="blue" onclick="jsRegistOk('1004','ND_goodsExmntUpdate.do');" />
          </c:if>
          <c:if test="${dataVo.goodsRegistSttus != 1002 and dataVo.goodsRegistSttus != 1005}">
          <input type="button" value="즉시승인" class="blue" onclick="jsGoodsUpdateAction('1007','ND_goodsExmntUpdate.do');" />
          </c:if>
      </div>
    ...
    <table class="boardWrite">
        ...
        <tbody>
        	<c:if test="${not empty dataVo.gcFile[0]}">
        	<!-- 변경 사유서 첨부 -->
            <tr>
                <th><span class="tx_red_s">*</span> 변경 사유서 첨부</th>
                <td>
                    <a href="/component/file/ND_fileDownload.do?id=${dataVo.gcFile[0].fileId }">${dataVo.gcFile[0].localNm}
						<span class="tx_gray">(${dataVo.gcFile[0].fileSize}, ${dataVo.gcFile[0].fileType})</span>
					</a>
                </td>
            </tr>
            </c:if>
    ...
    <table class="boardWrite mar_t20">
        ...
        <tbody>
			...
			<tr>
				...
				<td><span class="agree">
				<label><input type="radio" id="smlpzChk" name="smlpzChk" value="Y"  <c:if test="${dataVo.smlpzChk  == 'Y'}" >checked="checked" </c:if>  /> 중소기업</label>
			...
			<tr>
			    <th>변경단가</th>
				<td>
				    <input type="text" name="goodsChngPc" class="w_92p" value='${dataVo.goodsChngPc}'  maxlength="50"></input>
				    <br/><span class="caption">* 금액을 수정하려면 변경단가에 입력해 주세요.</span>
				</td>
			</tr>						
			<!-- //변경단가 -->	
    ...
    <table class="boardWrite mar_t20">
        ...
        <tbody>
            <tr><th colspan="6"><h4>판매자 정보</h4></th></tr>
            <tr>
 ...
 <!-- 2016.12.09 수정  소계영상, 홈페이지URL 삭제요청으로 주석처리함 -->
	...
	<%-- <table class="boardWrite mar_t20">
        ...
        <tbody>
            <tr><th colspan="6"><h4>서비스규격서정보</h4></th></tr>
            <tr>
				<th>공급사</th>
