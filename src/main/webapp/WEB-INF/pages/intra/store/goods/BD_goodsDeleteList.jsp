...
//             }
    ...
    var jsMovePage = function(page){
        ...
        $("#dataForm").attr("action", "BD_goodsDeleteList.do");
        $("#dataForm").submit();
    };
...
//        document.dataForm.action = "BD_goodsDeleteList.do";
...
<%--                         <td><input type="checkbox" name="goodsCodes" value="${baseVo.goodsCode}"/></td> --%>
                        ...
                        <td>
	                        <c:if test="${baseVo.mngrDeleteAt=='Y'}">관리자</c:if><c:if test="${baseVo.goodsActvtyAt=='N'}">제공자</c:if>
                        </td>
                        <td>
