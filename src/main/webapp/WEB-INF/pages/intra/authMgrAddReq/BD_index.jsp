...
<div>
    <ul class="tab">
        <li><a href="<c:url value="BD_index.do" />" class="on">권한추가(${dataVo.listCountA}건)</a></li>
        <li><a href="<c:url value="/intra/authMgrDelReq/BD_index.do" />">권한삭제(${baseVo.listCountD}건)</a></li>
    </ul>
</div>
...
<form name="dataForm" method="post">
    ...
    <div class="search">
       <fieldset>
           ...
           <div>
                <!-- <label for="q_searchKey2">상태 </label> -->
    ...
    <op:pagerParam view="list" title="권한 추가요청 목록" />
</form>
<table class="boardList" cellspacing="0" border="0" summary="게시판 리스트입니다.">
    ...
    <tbody id="odd-color">
        ...
        <tr>
            <td>${_bean.seqNo}</td>
            <td class="tx_l"><a href="#" title="권한요청관리 상세조회" onclick="jsView('${_bean.seqNo}','${_bean.mgrId }' ); return false;">${_bean.mgrNm }의 권한을
