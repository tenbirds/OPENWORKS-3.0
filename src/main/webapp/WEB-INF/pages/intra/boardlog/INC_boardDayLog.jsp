...
<script type="text/javascript">
	var jsReloadTerm = function(){
		...
		logTab.changeUrl(logTab.selectedIndex, 'INC_boardLog.do?typeCd=' + typeCd + '&searchYear=' + year + '&searchMonth=' + month);
		logTab.refresh();
	};
	...
	Ext.onReady(function(){
		...
		Ext.create('widget.panel', {
			height: 350,
			title: '${searchVO.searchYear}년 ${searchVO.searchMonth}월 일간 게시물 통계',
			renderTo: '_chart1',
			layout: 'fit',
			items: chart
		});
