...
<script type="text/javascript">
	var jsReloadTerm = function(){
		...
		logTab.changeUrl(logTab.selectedIndex, 'INC_fileLog.do?typeCd=' + typeCd + '&searchYear=' + year + '&searchMonth=' + month);
		logTab.refresh();
	};
	...
	Ext.onReady(function(){
		...
		Ext.create('widget.panel', {
			height: 350,
			title: '${searchVO.searchYear}년 ${searchVO.searchMonth}월 일간 파일 다운로드 통계',
			renderTo: '_chart2',
			layout: 'fit',
			items: chart1
		});
		...
		Ext.create('widget.panel', {
			height: 350,
			title: '${searchVO.searchYear}년 ${searchVO.searchMonth}월 일간 파일 업로드 통계',
			renderTo: '_chart3',
			layout: 'fit',
			items: chart2
		});
