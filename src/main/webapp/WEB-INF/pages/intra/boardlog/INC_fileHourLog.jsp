...
<script type="text/javascript">
	var jsReloadTerm = function(){
		...
		var month = $("#searchMonth2").val();
		var day = $("#searchDay2").val();
		logTab.changeUrl(logTab.selectedIndex, 'INC_fileLog.do?typeCd=' + typeCd + '&searchYear=' + year + '&searchMonth=' + month + '&searchDay=' + day);
		logTab.refresh();
	};
	...
	Ext.onReady(function(){
		...
		Ext.create('widget.panel', {
			height: 350,
			title: '${searchVO.searchYear}년 ${searchVO.searchMonth}월 ${searchVO.searchDay}일 시간당 파일 다운로드 통계',
			renderTo: '_chart2',
			layout: 'fit',
			items: chart1
		});
		...
		Ext.create('widget.panel', {
			height: 350,
			title: '${searchVO.searchYear}년 ${searchVO.searchMonth}월 ${searchVO.searchDay}일 시간당 파일 업로드 통계',
			renderTo: '_chart3',
			layout: 'fit',
			items: chart2
		});
...
<div class="mar_b10">
	<form>
		...
		<select id="searchMonth2" onchange="jsReloadTerm();">
		...
		<select id="searchDay2" onchange="jsReloadTerm();">
