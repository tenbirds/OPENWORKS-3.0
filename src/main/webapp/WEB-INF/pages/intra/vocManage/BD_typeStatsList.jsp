...
//<![CDATA[
    ...
    var jsSearch = function(){
        document.dataForm.action = "BD_typeStatsList.do";
...
<body>
    <div id="contents">
         <!-- 검색 -->
        <form name="dataForm" id="dataForm" method="get" action="BD_typeStatsList.do">
	        ...
	        <table class="boardList" cellspacing="0" border="0" summary="리스트입니다.">
	            ...
	            <thead>
	            	<tr>
		                ...
		                <th rowspan="2">회원탈퇴</th>
		                <th rowspan="2">협약체결</th>
		                <th rowspan="2">서비스등록/수정</th>
		                <th rowspan="2">서비스문의</th>
		                <th rowspan="2">기타</th>
		                <th rowspan="2">합계</th>
	                </tr>
	            </thead>
