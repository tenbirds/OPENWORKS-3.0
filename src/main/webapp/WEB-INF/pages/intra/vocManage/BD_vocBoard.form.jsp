			...
			<table class="boardWrite" cellspacing="0" border="0" summary="게시판 내용 작성페이지입니다.">
				...
				<tbody>
					<tr>
						...
						<td>
							<select id="memberAt" name="memberAt" title="회원 구분을 선택해주세요" class="over">
					...
					<tr>
						<th>
							<label for="insttTyNm">기관분류<span class="tx_red tx_b">*</span></label>
						</th>
						<td>
							<select id="insttTyNm" name="insttTyNm" title="기관분류 유형을 선택해주세요" class="over">
								<option value="">전체</option>
								<option value="" selected="selected">공공기관</option>
								<option value="">중앙행정기관</option>
								<option value="">지자체</option>
								<option value="">제공기업</option>
								<option value="">기타(개인)</option>
							</select>
						</td>
