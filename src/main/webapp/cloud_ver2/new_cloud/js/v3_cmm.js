   ...
   ***************************/
   ...
   $.fn.jqTransSelect = function(){
       return this.each(function(index){
           ...
           $wrapper.prepend('<div><span></span><a href="none" class="jqTransformSelectOpen" alt="선택" style="cursor: pointer;" title="선택"><img src="/cloud_ver2/new_cloud/images/icn_arr_down.png" alt="선택"/></a></div><ul></ul>');
