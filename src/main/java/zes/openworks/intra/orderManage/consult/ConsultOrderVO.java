 ...
 * @see
 */
public class ConsultOrderVO extends PaggingVO {

    /**  */
    private static final long serialVersionUID = -5414083308209437482L;
    /** 사용자아이디 */
    ...
    //서비스상태
    private String goodsRegistSttus;
    //서비스가격
    ...
    /**
     * String goodsRegistSttus을 반환
     * @return String goodsRegistSttus
     */
    public String getGoodsRegistSttus() {
     ...
     * @param goodsRegistSttus 을(를) String goodsRegistSttus로 설정
     */
    public void setGoodsRegistSttus(String goodsRegistSttus) {
