 ...
 */
@Repository
public class SysEnvDAO extends EgovAbstractMapper {
    ...
    public List<ResultVO> getStatisticList(SearchVO vo) {
        ...
        return list("_analyzeSysEnv." + vo.getAnalyzeId() + ".getStatisticList", vo);
    }

    public ResultVO getStatisticSum(SearchVO vo) {

        return (ResultVO) selectByPk("_analyzeSysEnv." + vo.getAnalyzeId() + ".getStatisticSum", vo);
    }
}
