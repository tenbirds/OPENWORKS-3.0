...
public interface ConnectCntService {
    ...
    List<ResultVO> getStatistic(SearchVO vo);

    List<ResultVO> getStatisticTimeGroup(SearchVO vo);

    List<ResultVO> getStatisticWeekDateGroup(SearchVO vo);

    List<ResultVO> getStatisticTime(SearchVO vo);

    List<ResultVO> getStatisticWeekDate(SearchVO vo);
