 ...
 */
@Repository
public class SummaryDAO extends EgovAbstractMapper {

    @SuppressWarnings("unchecked")
    public List<ResultVO> getStatistic(SearchVO vo) {

        return list("_analyzeSummary." + vo.getAnalyzeId() + ".getStatistic", vo);
    }
    ...
    public ResultVO getStatisticSum(ResultVO vo) {
        ...
        return (ResultVO) selectByPk("_analyzeSummary." + vo.getAnalyzeId() + ".getStatisticSum", vo);
    }
