 ...
 */
package zes.openworks.intra.analyze.statistic.base;
...
public class BaseServiceImpl extends AbstractServiceImpl {
     ...
     * @param vo
     */
    protected void defaultSearchDate(SearchVO vo) {
    ...
    protected void defaultPagingData(SearchVO vo) {
     ...
     * @param vo
     */
    protected void defaultSearchTime(SearchVO vo) {
     ...
     * @param vo
     */
    protected void defaultSearchWeekDate(SearchVO vo) {
     ...
     * @param sourceList
     */
    protected void mergeValues(List<ResultVO> targetList, List<ResultVO> sourceList) {

        for(int i = 0 ; i < targetList.size() ; i++) {
            ResultVO targetVO = targetList.get(i);
            ResultVO sourceVO = sourceList.get(i);
     ...
     * @param sourceList
     */
    protected void setVariation(List<ResultVO> targetList, List<ResultVO> sourceList) {
    ...
    protected void setCompareDate(SearchVO vo) {
