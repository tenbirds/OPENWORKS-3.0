...
public interface VisitPathService {
    ...
    List<ResultVO> getStatisticList(SearchVO vo);

    List<ResultVO> getTopStatisticList(ResultVO vo, ResultVO sumVo);

    ResultVO getStatisticSum(SearchVO vo);

    Pager<ResultVO> getStatisticPageList(ResultVO vo, ResultVO sumVo);
