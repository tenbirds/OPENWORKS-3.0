 ...
 */
@Repository
public class VisiterDAO extends EgovAbstractMapper {
    ...
    public List<ResultVO> getStatisticList(SearchVO vo) {
        ...
        return list("_analyzeVisiter." + vo.getAnalyzeId() + ".getStatisticList", vo);
    }

    public ResultVO getStatisticSum(SearchVO vo) {

        return (ResultVO) selectByPk("_analyzeVisiter." + vo.getAnalyzeId() + ".getStatisticSum", vo);
    }
}
