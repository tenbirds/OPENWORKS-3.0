 ...
 */
package zes.openworks.intra.analyze.util;
...
public class CalcUtil {
    ...
    public static void getRateList(List<ResultVO> list, ResultVO sumVO) {
        for(ResultVO _vo : list) {
     ...
     * @return
     */
    public static ResultVO setSumValues(List<ResultVO> sourceList) {
     ...
     */
    public static void setSumValuesVariation(ResultVO vo, int idx) {
