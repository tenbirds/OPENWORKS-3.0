 ...
 *   수정일                  수정자                   수정내용
 * --------------  --------  ---------------------------------
 *  2012. 6.  1.     손재숙      JDK 1.6 이상 버전에 최적화 수정 및 주석 보강
 * </pre>
 * @see
 */

@Service("ebookBoardService")
public class EbookBoardServiceImpl extends AbstractServiceImpl implements BoardService {
    ...
    public String deleteComment(BoardCmtVO boardCmtVO) {
        return (String) boardDao.deleteComment(boardCmtVO);
    }
