...
public class StickyNoteServiceImpl implements StickyNoteService {
    ...
    public List<StickyNoteVO> stickyNoteList(String mgrId) {
        ...
        return stickyNoteDao.stickyNoteList(mgrId);
    }
    ...
    public Integer insertAction(StickyNoteVO StickyNoteVO) {
        ...
        return stickyNoteDao.insertAction(StickyNoteVO);
    }
    ...
    public int updateAction(StickyNoteVO StickyNoteVO) {
        ...
        return stickyNoteDao.updateAction(StickyNoteVO);
    }
    ...
    public int deleteAction(StickyNoteVO StickyNoteVO) {
        ...
        return stickyNoteDao.deleteAction(StickyNoteVO);
    }
