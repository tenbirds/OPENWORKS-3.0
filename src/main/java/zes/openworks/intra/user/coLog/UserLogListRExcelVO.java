 ...
 * @see
 */
public class UserLogListRExcelVO implements IExcelVO {
...
//        header.createCell(colIndex++).setCellValue("성명");
        header.createCell(colIndex++).setCellValue("조회일시");
        header.createCell(colIndex++).setCellValue("조회자");
//        header.createCell(colIndex++).setCellValue("조회자 ID");
        header.createCell(colIndex++).setCellValue("조회사유");
