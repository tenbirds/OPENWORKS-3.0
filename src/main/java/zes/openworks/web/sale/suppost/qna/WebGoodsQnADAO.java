...
public class WebGoodsQnADAO extends EgovAbstractMapper {
    ...
    public Pager<WebGoodsQnAVO> qnaList(WebGoodsQnAVO vo) {
        ...
        List<WebGoodsQnAVO> dataList = list("_webgoodsqna.qnaList", vo.getDataMap());
        vo.setTotalNum((Integer) selectByPk("_webgoodsqna.qnaCount", vo.getDataMap()));

        // 원상복구
        vo.getDataMap().put("q_langCodes", langCodes);
        vo.getDataMap().put("q_goodsTyCds", goodsTyCds);

        return new Pager<WebGoodsQnAVO>(dataList, vo);
    }
    ...
    public WebGoodsQnAVO commentView(WebGoodsQnAVO vo) {
        return (WebGoodsQnAVO) selectByPk("_webgoodsqna.commentView", vo);
    }
    ...
    public int commentUpdateAction(WebGoodsQnAVO vo) {
        return update("_webgoodsqna.commentUpdateAction", vo);
    }
