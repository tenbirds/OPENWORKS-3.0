 ...
 * @see
 */
public class SuplerCeartSaas2DoVO extends PaggingVO {
    ...
    /**
     * optionSeq을 설정
     * @param optionSeq 을(를) int optionSeq로 설정
     */
