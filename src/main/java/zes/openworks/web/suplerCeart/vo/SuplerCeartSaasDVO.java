 ...
 * @see
 */
public class SuplerCeartSaasDVO extends PaggingVO {
    ...
    /**
     * String cmntCd을 반환
     * @return String cmntCd
     */
    public String getCmntCd() {
        return cmntCd;
    }
    ...
    /**
     * cmntCd을 설정
     * @param cmntCd 을(를) String cmntCd로 설정
     */
    public void setCmntCd(String cmntCd) {
        this.cmntCd = cmntCd;
    }
