 ...
 * @see
 */
public class SuplerCeartBidNotifyVO extends PaggingVO {
    ...
    /** 수요자대표전화 */
    private String endsMbtlnum;
    
    /** 수요자e-mail */
    private String endsEmail;
    ...
    /**
     * String endsMbtlnum을 반환
     * @return String endsMbtlnum
     */
    public String getEndsMbtlnum() {
        return endsMbtlnum;
    }
    ...
    /**
     * endsMbtlnum을 설정
     * @param endsMbtlnum 을(를) String endsMbtlnum로 설정
     */
    public void setEndsMbtlnum(String endsMbtlnum) {
        this.endsMbtlnum = endsMbtlnum;
    }

    
    /**
     * String endsEmail을 반환
     * @return String endsEmail
     */
    public String getEndsEmail() {
        return endsEmail;
    }
    ...
    /**
     * endsEmail을 설정
     * @param endsEmail 을(를) String endsEmail로 설정
     */
    public void setEndsEmail(String endsEmail) {
        this.endsEmail = endsEmail;
    }
    ...
    /**
     * String extendTermYn을 반환
     * @return String extendTermYn
     */
    public String getExtendTermYn() {
        return extendTermYn;
    }
    ...
    /**
     * extendTermYn을 설정
     * @param extendTermYn 을(를) String extendTermYn로 설정
     */
    public void setExtendTermYn(String extendTermYn) {
        this.extendTermYn = extendTermYn;
    }
