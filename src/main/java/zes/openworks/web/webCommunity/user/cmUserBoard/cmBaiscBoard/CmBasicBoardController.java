 ...
 * with OMP Inc. 
 */
package zes.openworks.web.webCommunity.user.cmUserBoard.cmBaiscBoard;
 ...
 */
@Controller
@RequestMapping(value = "/**/cm/user/cmUserBoard/cmBasicBoard")
public class CmBasicBoardController extends WebController {
     ...
     * 커뮤니티 사용자 기본 게시판 
     */
    @RequestMapping(value = "BD_cmBasicBoardList.do")
    public void cmUserBasicBoardList(HttpServletRequest request, ModelMap model, CmManageBoardVO vo , CmManageVO cmv){
     ...
     * 커뮤니티 사용자 기본 게시판 상세
     */
    @RequestMapping(value = "BD_cmBasicBoardView.do")
     ...
     * 커뮤니티 사용자 기본 등록 폼 
     */
    @RequestMapping(value = "BD_cmBasicBoardForm.do")
    public void cmUserBasicBoardForm(HttpServletRequest request, ModelMap model, CmManageBoardVO vo, CmManageVO cmv){
        OpHelper.bindSearchMap(vo, request);
        OpHelper.bindSearchMap(cmv, request);
     ...
     * 
     */
    @RequestMapping(value = "INC_cmBasicBoardInsert.do")
    public String cmUserBasicBoardInsert( HttpServletRequest request, ModelMap model ,CmManageBoardVO vo, CmManageVO cmv) {
     ...
     * 
     */
    @RequestMapping(value = "INC_cmBasicBoardUpdate.do")
    public String cmUserBasicBoardUpdate( HttpServletRequest request, ModelMap model ,CmManageBoardVO vo, CmManageVO cmv) {
     ...
     * 
     */
    @RequestMapping(value = "INC_cmBasicBoardDelete.do")
    public String cmUserBasicBoardDelete( HttpServletRequest request, ModelMap model ,CmManageBoardVO vo, CmManageVO cmv) {
     ...
     * 커뮤니티 사용자 기본 댓글 게시판 
     */
    @RequestMapping(value = "INC_cmBasicBoardCMT.do")
    public void cmBasicBoardCMTList(HttpServletRequest request, ModelMap model, CmManageBoardVO vo , CmManageVO cmv){
    ...
    /**
     *  커뮤니티 사용자 기본 게시판 댓글 등록
     * 
     */
    @RequestMapping(value = "INC_cmBasicBoardCMTInsert.do")
    public String cmBasicBoardCMTInsert( HttpServletRequest request, ModelMap model ,CmManageBoardVO vo) {
    ...
    /**
     * 커뮤니티 사용자 기본 게시판 댓글 수정폼
     * return true/false
     */
    @RequestMapping(value = "INC_cmBasicBoardCMTForm.do")
    public String cmBasicBoardCMTForm(ModelMap model, HttpServletRequest request, CmManageBoardVO vo) throws Exception {
...
//        dataVO.setNttCmtCn(Converter.cleanHtml(dataVO.getNttCmtCn()));
     ...
     * 
     */
    @RequestMapping(value = "INC_cmBasicBoardCMTUpdate.do")
    public String cmBasicBoardCMTUpdate( HttpServletRequest request, ModelMap model ,CmManageBoardVO vo) {
     ...
     * 
     */
    @RequestMapping(value = "INC_cmBasicBoardCMTDelete.do")
    public String cmBasicBoardCMTDelete( HttpServletRequest request, ModelMap model ,CmManageBoardVO vo) {
