...
@Service("faqBoardWebService")
public class FaqBoardServiceImpl extends AbstractServiceImpl implements BoardService {
    ...
    public Pager<BoardVO> boardList(BoardVO boardVO, String listSkin) {
        ...
        List<BoardVO> dataList = boardWebDao.boardList(boardVO, listSkin).getList();
    ...
    public List<BoardVO> noticeList(BoardVO boardVO, String listSkin) {
        ...
        List<BoardVO> dataList = boardWebDao.noticeList(boardVO, listSkin);
