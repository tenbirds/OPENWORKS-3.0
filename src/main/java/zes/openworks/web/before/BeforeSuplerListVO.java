 ...
 * @see
 */
public class BeforeSuplerListVO extends PaggingVO {
    ...
    /**
     * String beforeNotifyNm을 반환
     * @return String beforeNotifyNm
     */
    public String getBeforeNotifyNm() {
        return beforeNotifyNm;
    }
    ...
    /**
     * beforeNotifyNm을 설정
     * @param beforeNotifyNm 을(를) String beforeNotifyNm로 설정
     */
    public void setBeforeNotifyNm(String beforeNotifyNm) {
        this.beforeNotifyNm = beforeNotifyNm;
    }
