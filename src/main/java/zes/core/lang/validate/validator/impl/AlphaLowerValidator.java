...
import zes.core.lang.validate.annotation.marker.AlphaLower;
 ...
 * @see
 */
public class AlphaLowerValidator extends AbstractValidator {

    @Override
    public Validator setAnnotation(Annotation annotation) {

        AlphaLower anno = (AlphaLower) annotation;
    ...
    protected boolean doValidate(Object propertyValue) {
        ...
        return Validate.isAlphaLower(value);
    }
