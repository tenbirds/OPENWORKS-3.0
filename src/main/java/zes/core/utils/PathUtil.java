 ...
 * @author wisepms
 * @since 2.0
 * @version $Id: PathUtil.java 23 2011-07-13 05:20:04Z oworks $
 */
public final class PathUtil {
    ...
    public static String replacePath(String mixPath) {
        ...
        return StringUtil.replace(mixPath, GlobalConfig.REPLACE_FILE_SEPARATOR,
            GlobalConfig.FILE_SEPARATOR);
    }
