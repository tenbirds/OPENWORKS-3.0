 ...
 * @author <a href="mailto:phkim@cluecom.co.kr">PilhoKim</a>
 * @author wisepms
 * @since 2.0
 * @version $Id: DateCalcUtil.java 23 2011-07-13 05:20:04Z oworks $
 */
public final class DateCalcUtil {
    ...
    public static String parseCalendar2(int year, int month, int day) {
