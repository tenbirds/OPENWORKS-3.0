...
/**
 * <code>Throwable</code> 객체를 표현하고 조작하기 위한 유틸리티 클래스.
 * 
 ...
 * @author wisepms
 * @since 1.0
 * @version $Id: ExceptionUtil.java 23 2011-07-13 05:20:04Z oworks $
 */
...
public class ExceptionUtil {
    ...
    /**
     * <p>
     * Public constructor allows an instance of <code>ExceptionUtil</code> to be
     * created, although that is not normally necessary.
     * </p>
     */
    ...
    public static void addCauseMethodName(String methodName) {
        if(Validate.isNotEmpty(methodName)) {
     ...
     * exceptions, including those from JDK 1.4. The method names can be added
     * to using {@link #addCauseMethodName(String)}.
     * </p>
     * <p>
    ...
    public static int indexOfThrowable(Throwable throwable, Class type, int fromIndex) {
        ...
        Throwable[] throwables = ExceptionUtil.getThrowables(throwable);
    ...
    public static String[] getStackFrames(String stackTrace) {
        String linebreak = SystemUtil.LINE_SEPARATOR;
    ...
    /**
     * Returns current stack trace not without this method in the trace. Since
     * an exception is thrown internally, this is a slow method.
     * 
